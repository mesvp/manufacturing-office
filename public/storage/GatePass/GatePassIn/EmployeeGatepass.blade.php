                                ...
                                <form id="submitform" action="{{ url('GatePass/employee-store') }}" method="POST">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody id="EmployeeGatepassFields">
                                                    ...
                                                    <tr id="itemRow1">
                                                        ...
                                                        <td>
                                                            <input class="form-control form-control-sm" type="text" name="emp_code[]" placeholder="Enter Employee code" value="" required>
                                                        </td>
                                                        <td>
                                                            <input class="form-control form-control-sm" type="text" name="emp_dept[]" placeholder="Enter Department" value="" required>
                                                        </td>
                                                        <td>
                                                            <input class="form-control form-control-sm" type="number" name="emp_phone[]" placeholder="Enter Phone No." value="" oninput="validatePhoneNumber(this, 1)" required>
                                                            <small id="empPhoneError1" style="color: red;"></small>
                                                        </td>                                                        
                                                        <td>
                                    ...
                                    @if (isset($edit->id) && $edit->id != '')
                                        <div class="row">
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input class="form-control form-control-sm" id="intime" type="text" name="request_in_time" placeholder="Request In Time" value="{{ isset($edit->request_in_time) && $edit->request_in_time != '' ? date('d-m-Y h:i A' , strtotime($edit->request_in_time)) : '' }}" required disabled>
                                            </div>
                                            <div class="col-sm-4 form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2 form-group">
                                                ...
                                                <input class="form-control form-control-sm" type="text" name="out_sec_guard_name" placeholder="Enter Guard Name" value="" id="sec_guard" required>
                                            </div>
                                            <div class="col-sm-2 form-group">
                                                <label for="sec_guard_phone">Security Ph No <span class="text-danger fw-bolder">*</span></label>
                                                <input class="form-control form-control-sm" type="text" name="out_sec_guard_phone" placeholder="Security Ph No" value="" id="sec_guard_phone" onkeyup="this.value=this.value.replace(/[^\d.]+/g,'')" required>
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <textarea class="form-control form-control-sm" name="out_visit_purpose" placeholder="Enter Visit Purpose" cols="30" rows="2"></textarea>
                                            </div>
                                            <div class="col-sm-2 form-group">
                                    ...
                                    @else
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                <label for="sec_guard">Security Guard Name <span class="text-danger fw-bolder">*</span></label>
                                                <input class="form-control form-control-sm" type="text" name="sec_guard_name" placeholder="Enter Guard Name" value="" id="sec_guard" required>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label for="sec_guard_phone">Security Ph No <span class="text-danger fw-bolder">*</span></label>
                                                <input class="form-control form-control-sm" type="text" name="sec_guard_phone" placeholder="Security Ph No" value="" id="sec_guard_phone" onkeyup="this.value=this.value.replace(/[^\d.]+/g,'')" required>
...
@push('custom-scripts')
    ...
    <script>
        function validatePhoneNumber(input, index) {
            var phoneError = document.getElementById('empPhoneError' + index);
        ...
        function empgatepassAppend(i) {
            ...
            $('#EmployeeGatepassFields').append(`
                <tr id="empgatepassRemove${i}">
                    ...
                    <td>
                        <select class="form-select form-select-sm js-example-matcher-start" name="emp_shift[]" required>
                            <option value="0" selected disabled>Select Shift</option>
                            ${options}
                        </select>
                    </td>
                    <td class="item-desc-cell">
                    ...
                    <td>
                        <input class="form-control form-control-sm" type="number" name="emp_phone[]" placeholder="Enter Phone No." value="" required oninput="validatePhoneNumber(this, ${i})">
                        <small id="empPhoneError${i}" style="color: red;"></small>
                    </td>
                    <td>
