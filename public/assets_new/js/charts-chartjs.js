...
// Deenabandhu Horizontal Bar Chart barChart
  
const goalsbarChart = document.getElementById('goalsbarChart');
  if (goalsbarChart) {
    const barChartVar = new Chart(goalsbarChart, {
      type: 'bar',
      data: {
        labels: [
          'January',
  ...
  if (polarChart) {
    const polarChartVar = new Chart(polarChart, {
      type: 'polarArea',
      data: {
        labels: ['Hot Lead 35', 'Cold Lead 25', 'Warm Lead 40'],
        datasets: [
          {
            label: 'Lead)',
            backgroundColor: [orangeColor, cyanColor, yellowColor ],
            data: [35, 25, 40],
            borderWidth: 0
          }
        ]
