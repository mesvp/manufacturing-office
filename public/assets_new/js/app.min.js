...
function(i) {
    "use strict";
    var t = function() {
        this.$bootstrapStylesheet = i("#bootstrap-stylesheet"), this.$appStylesheet = i("#app-stylesheet"), this.$originalBSStylesheet = i("#bootstrap-stylesheet").attr("href"), this.$originalAppStylesheet = i("#app-stylesheet").attr("href")
    };
    t.prototype.init = function() {
        var t = this;
        i("#light-mode-switch").on("change", function() {
            this.checked && (t.$bootstrapStylesheet.attr("href", t.$originalBSStylesheet), t.$appStylesheet.attr("href", t.$originalAppStylesheet), i("#dark-mode-switch").prop("checked", !1), i("#rtl-mode-switch").prop("checked", !1))
        }), i("#dark-mode-switch").on("change", function() {
            this.checked && (t.$bootstrapStylesheet.attr("href", i(this).data("bsstyle")), t.$appStylesheet.attr("href", i(this).data("appstyle")), i("#light-mode-switch").prop("checked", !1), i("#rtl-mode-switch").prop("checked", !1))
        }), i("#rtl-mode-switch").on("change", function() {
            this.checked && (t.$bootstrapStylesheet.attr("href", t.$originalBSStylesheet), t.$appStylesheet.attr("href", i(this).data("appstyle")), i("#light-mode-switch").prop("checked", !1), i("#dark-mode-switch").prop("checked", !1))
        })
    }, i.RightSidebar = new t, i.RightSidebar.Constructor = t
}(window.jQuery),
function(e) {
    "use strict";
    var t = function() {
    ...
    t.prototype._resetSidebarScroll = function() {
        ...
        var i = this;
        this.initLayout(), this.initMenu(), e.Components.init(), e.RightSidebar.init(), i.$window.on("resize", function(t) {
