...
class HrController extends Controller
{
    ...
    public function index()
    {
        ...
        $userdata=Admin::where('role','!=','0')->where('role','!=','1')->get();
        return view('hr.employee.index',['user'=>$userdata]);
    }
   

    public function add_employee()
    {
        $role = Role::where('name','!=','Hr Manager')->get();
        return view('hr.employee.add_employee',['role'=>$role]);
    }
    public function add_employee_data(Request $request)
    {
        ...
        if($res)
        {
            return redirect('hr/employees')->withSuccess("Added Successfully...");
        }
        else
        {
    ...
    public function edit_emp($id)
    {
        ...
        return view('hr.employee.edit_employee', ['editt' => $edit, 'role' => $role]);
    }
