    ...
    <div class="app-content">
        ...
        <section class="section">
            <div class="addbtn extra">
                <a href="{{url('ProductCategories/ProductApproveList')}}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> BACK</a>
                <a href="{{url('ProductCategories/ProductApproveList')}}" class="btn btn-info" style="margin-left:10px"> <i class="fa fa-home"></i> Home</a>
            </div>
            <div class="row">
                <div class="container">
                    <br>
                ...
                <form action="{{url('ProductCategories/approve')}}" method="POST">
                    ...
                    <div class="tab-content" id="myTabContent">
                        @if($edit->Approve_status!='APPROVE' && in_array(1, $STEP) || in_array(2, $STEP) || in_array(3, $STEP) || isset($EXT[5]['Forward']))
