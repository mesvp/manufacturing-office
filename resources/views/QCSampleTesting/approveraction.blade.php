...
<form action="{{url('QCSampleTesting/approve')}}" method="POST">
    @csrf
    ...
    <a href="{{url('QCSampleTesting/ApproverView/'.$nextID)}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
    @else
    <a href="{{url('QCSampleTesting/StoreRequistionApproveList')}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
    @endif
</form>
@endif
<script>
