    ...
    <div class="app-content">
        ...
        <section class="section">
            <div class="addbtn extra">
                ...
                <a href="{{$type==0?url('QCSampleTesting/STDFinishedGoodsList'):url('QCSampleTesting/STDFinishedGoodsApproverList')}}" class="btn btn-info" style="margin-left:10px"> <i class="fa fa-home"></i> Home</a>
            </div>
            <div class="row">
                <div class="container">
                    <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        id = '{{$id}}'
        $.post("{{url('QCSampleTesting/Formview')}}", {
            id: id
        }, function(data) {
            $("#formview").html(data);
            materialdata()
        ...
        ////////////////////////
        $.post("{{url('QCSampleTesting/action/')}}/{{$type??0}}", {
            id: id
        }, function(data) {
            $("#action").html(data);
        });
        /////////////////
        $.post("{{url('QCSampleTesting/trail')}}", {
            id: id
        }, function(data) {
            $("#trail").html(data);
        });
    ...
    function materialdata() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("input[name='otherQTY[]']").attr('disabled', true);
            }
        });
