    ...
    <div class="app-content">
        ...
        <section class="section">
            <div class="addbtn extra">
                ...
                <a href="{{$type==1?url('SampleFreeGood/SampleFreeGoodApproveList'):url('SampleFreeGood/SampleFreeGoodList')}}" class="btn btn-info" style="margin-left:10px"> <i class="fa fa-home"></i> Home</a>
            </div>
            <div class="row">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col">
                                    <h5>Sample & Free Good View Page</h5>
                                </div>
                                <div class="col">
...
<script>
    ...
    $(document).ready(function() {
        id = '{{$id}}'
        $.post("{{url('SampleFreeGood/Formview')}}", {
            id: id
        }, function(data) {
            $("#formview").html(data);
            rawmaterial(0,1)
        ...
        ////////////////////////
        $.post("{{url('SampleFreeGood/action/')}}/{{$type??0}}", {
            id: id
        }, function(data) {
            $("#action").html(data);
        });
        /////////////////
        $.post("{{url('SampleFreeGood/trail')}}", {
            id: id
        }, function(data) {
            $("#trail").html(data);
        });
 ...
 function select()
 {
   ...
   $("#formview").find('input, textarea, button, select').attr('disabled',true)
   $("#formview").find('button').remove()
 }
