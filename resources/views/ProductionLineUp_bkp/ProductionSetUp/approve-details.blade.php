    ...
    <div class="card">
      ...
      <div class="card-body">
                                ...
                                <div class="col-xl-5 col-md-7">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-12">
                                            ...
                                            <!-- <input id="rowInput" class="form-control" type="text" placeholder="{{ $details->cellRow }}" disabled> -->
                                            <input id="rowInput" class="form-control" type="text"
                                                value="{{ $details->cellRow }}" disabled>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-12">
                                            <label class="form-label">Column No</label>
                                            <!-- <input id="columnInput" class="form-control" type="text" placeholder="{{ $details->celColumn }}" disabled> -->
        ...
        <div class="col-12 mt-2">
          ...
          <form action="{{ url('production-lineup/production-setup/approvalAction') }}" method="post">
            @csrf
            ...
            <div class="row mt-2">
              ...
              <div class="col-md-6" style="text-align:right;">
                <button class="btn btn-primary" type="submit" name="submitData" value="{{ $details->batchNo }}_{{ $details->stage }}_{{ $details->stage_title }}">Submit</button>
              </div>
            </div>
