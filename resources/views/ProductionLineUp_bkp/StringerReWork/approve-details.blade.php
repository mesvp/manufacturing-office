...
@section('pageHeading')
    Stringer Re-Work Request View Details
@endsection
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                <h5 class="mb-0">Stringer Re-Work Request View :</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <span>{{ $stringerReworkDetails->batchNo ?? '' }}</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="fw-medium text-black">Date :</label>
                            <span>{{ isset($stringerReworkDetails->date) ? date('d/m/Y', strtotime($stringerReworkDetails->date)) : '' }}</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="fw-medium text-black">Shift :</label>
                            <span>{{ $stringerReworkDetails->shiftdtl ?? '' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <span>{{ $stringerReworkDetails->plant ?? '' }}</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <span>{{ $stringerReworkDetails->operatorName ?? '' }}</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="fw-medium text-black">Checker :</label>
                            <span>{{ $stringerReworkDetails->checkerName ?? '' }}</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive border rounded-4 border-bottom-0">
                            <table class="table m-0">
                                ...
                                <tbody>
                                    @if (count($stringerReworkMaterials) > 0)
                                        @foreach ($stringerReworkMaterials as $index => $material)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ 'String' }}</td>
                                                <td>{{ $material->tableNo ?? '' }}</td>
                                                <td>{{ $material->time ?? '' }}</td>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="8" class="text-center text-danger text-uppercase">No materials found ...</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($stringerReworkHistory as $index => $history)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                ...
                <div class="col-12 mt-2">
                    ...
                    <form action="{{ url('production-lineup/stringer-rework/approvalAction') }}" method="post">
                        @csrf
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6" style="text-align:right;">
                                <button class="btn btn-primary" type="submit" name="submitData" value="{{ $details->id }}_{{ $details->stage }}_{{ $details->stage_title }}">Submit</button>
                            </div>
                        </div>
