...
@section('pageHeading')
    Stringer Rework Detailed Report
@endsection
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                            <h5 class="mb-0">Stringer Rework Detailed Report :</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form>
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                        ...
                                        <a href="{{ url('production-lineup/stringer-rework-detailed') }}"><button
                                    ...
                                    @foreach ($AllLists as $key => $apprvDataList)
                                        @if ($apprvDataList->status == 1)
                                            <tr>
                                                ...
                                                <td>{{ 'String' }}</td>
                                                <td>{{ $apprvDataList->tableNo ?? '' }}</td>
                                                <td>{{ $apprvDataList->cellPosition ?? '' }}</td>
                                                <td>{{ $apprvDataList->efficiency ?? '' }}</td>
                                                ...
                                                <td> {{ 'Approved By ' . $apprvDataList->actionByName }}</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                </tbody>
