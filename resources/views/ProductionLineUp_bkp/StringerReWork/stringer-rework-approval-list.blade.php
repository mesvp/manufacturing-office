...
@section('pageHeading')
    Stringer Rework Approval List Details
@endsection
<style>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Stringer Rework Approval</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{url('production-lineup/stringer-rework-approval-list')}}"><button type="button" class="btn btn-outline-success">Refresh</button></a>
                                </div>
                            </div>
                        </form>
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    ...
                                                                    <li><a href="{{ url('production-lineup/stringer-rework-view/' . $pendDataList->id . '?menu=stringer-rework-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if (in_array($empId, $approverList) && $pendDataList->status == 0)
                                                                        <li><a href="{{ url('production-lineup/stringer-rework/approve/' . $pendDataList->id) }}"
                                                                                class="dropdown-item"><i
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    <li><a href="{{ url('production-lineup/stringer-rework-view/' . $holdDataList->id . '?menu=stringer-rework-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if ($holdDataList->actionBy == $empId && $holdDataList->status == 3)
                                                                        <li><a href="{{ url('production-lineup/stringer-rework/approve/' . $holdDataList->id) }}"
                                                                                class="dropdown-item"><i
                                                                                    class="mdi mdi-check"></i> Approval
                                                                                Action</a></li>
                                                                    @endif
