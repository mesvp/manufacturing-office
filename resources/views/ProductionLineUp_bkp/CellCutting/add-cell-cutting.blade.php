    ...
    <script>
        ...
        function addMaterialRow(material = {}) {
            ...
            <tr>
                ...
                <td><input type="number" min="0" name="materials[${materialIndex}][production_qty]" class="form-control invoice-item-price w-px-12" placeholder="Production Qty" required></td>
                <td><input type="number" min="0" name="materials[${materialIndex}][rejection_qty]" class="form-control invoice-item-price w-px-12" placeholder="Rejection Qty" required></td>
