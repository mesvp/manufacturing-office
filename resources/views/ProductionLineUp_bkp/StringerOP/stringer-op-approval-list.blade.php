...
@section('pageHeading')
    Stringer OP Approval List Details
@endsection
<style>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Stringer OP Approval</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{ url('production-lineup/stringer-op') }}"><button type="button"
                                            ...
                                            @foreach ($AllLists as $key => $pendDataList)
                                                ...
                                                @if ($pendDataList->status == 0 && in_array($empId, $approverList))
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ date('d-m-Y H:i:s', strtotime($pendDataList->created_at)) }}
                                                        </td>
                                                        <td>
                                                            @php
                                                                $approverList = [];
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    ...
                                                                    <li><a href="{{ url('production-lineup/stringer-op-view/' . $pendDataList->id . '?menu=stringer-op-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if (in_array($empId, $approverList) && $pendDataList->status == 0)
                                                                        <li><a href="{{ url('production-lineup/stringer-op/approve/' . $pendDataList->id . '?menu=stringer-op-approval-list') }}"
                                                                                class="dropdown-item"><i
                                            ...
                                            @foreach ($AllLists as $key => $recheckDataList)
                                                @if ($recheckDataList->status == 2 && $empId == $recheckDataList->actionBy)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ date('d-m-Y H:i:s', strtotime($recheckDataList->created_at)) }}
                                                        <td>
                                                            @php
                                                                $approverList = [];
                                                                $person = '';
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ url('production-lineup/stringer-op-view/' . $recheckDataList->id . '?menu=stringer-op-approval-list') }}"
                                            ...
                                            @foreach ($AllLists as $key => $holdDataList)
                                                ...
                                                @if ($holdDataList->status == 3 && in_array($empId, $approverList))
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ date('d-m-Y H:i:s', strtotime($holdDataList->created_at)) }}
                                                        <td>
                                                            @php
                                                                $approverList = [];
                                                                $person = '';
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    <li><a href="{{ url('production-lineup/stringer-op-view/' . $holdDataList->id . '?menu=stringer-op-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if ($holdDataList->actionBy == $empId && $holdDataList->status == 3)
                                                                        <li><a href="{{ url('production-lineup/stringer-op/approve/' . $holdDataList->id . '?menu=stringer-op-approval-list') }}"
                                                                                class="dropdown-item"><i
                                                                                    class="mdi mdi-check"></i> Approval
                                                                                Action</a></li>
                                                                    @endif
