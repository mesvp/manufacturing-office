                ...
                <form action="{{ url('production-lineup/el-qc/update/' . $e->elqc_id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" id="batchno" value="{{ $e->elqc_batchNo ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Date</label>
                            <input class="form-control" id="date" value="{{ $e->elqc_date ?? '-' }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Time</label>
                            <input class="form-control" id="time" value="{{ $e->elqc_time ?? '-' }}">
                        </div>
                        <div class="col-md-3">
...
@section('pageScript')
    <script>
        $(document).ready(function() {
            const bushingNo = $('#bushing_no').val();
