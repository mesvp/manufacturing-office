    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                <h5 class="mb-0">Add Request page (Stringer QC) :</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                <form action="{{ route('stringer-qc-store') }}" method="POST">
                    @csrf
...
@section('pageScript')
    <script>
        ...
        function addMaterialRow(material = {}) {
            ...
            const row = `
                <tr>
                    ...
                    <td>
                        <input type="text" name="materials[${materialIndex}][stringer_no]" class="form-control invoice-item-price w-px-120" placeholder="Stringer No" required readonly>
                    </td>
        ...
        function showHint(batchNo) {
            ...
            $.ajax({
                url: "{{ url('production-lineup/stringer-qc/getstringerQCMaterial') }}",
                type: "GET",
                data: { q: batchNo },
