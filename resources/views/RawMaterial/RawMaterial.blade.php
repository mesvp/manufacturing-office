                                            ...
                                            <div class="tab1 col-sm-11 row">
                                                <div class="col-sm-3 form-group">
                                                    <label>
                                                        ...
                                                        <select name="Raw_Material[{{$i}}][{{$j}}]" class="form-select form-select-sm js-example-matcher-start" id="RawMaterial{{$i}}{{$j}}" onclick="Material({{$i}},{{$j}})" disabled required>
                                                            <option value="" selected disabled>Select</option>
                                                            @foreach($Raw_Materialdata as $val)
                                    ...
                                    <div class="tab1 col-sm-11">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <input class="form-control form-control-sm date" type="text" name="date[0]" placeholder="Current date" value="" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="tab1 col-sm-11 row">
