                                            ...
                                            <div class="tab1 col-sm-11 row">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <div class="field-wrap">
                                                        <input class="form-control form-control-sm" type="number" id="HSNCode{{$i}}{{$j}}" name="HSN_Code[{{$i}}][{{$j}}]" placeholder="HSN Code" value="{{isset($dataVal->HSN_Code) && $dataVal->HSN_Code!=''?$dataVal->HSN_Code:''}}" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>UOM</label>
                                                    <div class="field-wrap">
                                                        <input class="form-control form-control-sm" type="text" id="UOM{{$i}}{{$j}}" name="UOM[{{$i}}][{{$j}}]" placeholder="UOM" value="{{isset($dataVal->UOM) && $dataVal->UOM!=''?$dataVal->UOM:''}}" required disabled>
