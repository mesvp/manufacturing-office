                ...
                <div class="tab1">
                        ...
                        <div class="row">
                          <div class="col-sm-2 form-group">
                            <label>Total Capacity*</lable>
                              <p><input class="form-control form-control-sm" id="totalcapacity{{$i}}" onchange="totalCapacity({{$i}})" placeholder="" name="Total_Capacity[]" value="{{isset($Electricity->Total_Capacity) && $Electricity->Total_Capacity!=''?$Electricity->Total_Capacity:''}}" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Running Capacity*</lable>
                              <p><input class="form-control form-control-sm" id="runningcapacity{{$i}}" onchange="totalCapacity({{$i}})" placeholder="" name="Running_Capacity[]" value="{{isset($Electricity->Running_Capacity) && $Electricity->Running_Capacity!=''?$Electricity->Running_Capacity:''}}" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Meter*</lable>
                              <p><input type="number" class="form-control form-control-sm" placeholder="" name="Meter[]" value="{{isset($Electricity->Meter) && $Electricity->Meter!=''?$Electricity->Meter:''}}" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Sub Meter*</lable>
                              <p><input type="number" class="form-control form-control-sm" placeholder="" name="Sub_Meter[]" value="{{isset($Electricity->Sub_Meter) && $Electricity->Sub_Meter!=''?$Electricity->Sub_Meter:''}}" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Source Of Electricity*</lable>
                              <p><input class="form-control form-control-sm" type="text" placeholder="" name="Source_Of_Electricity[]" value="{{isset($Electricity->Source_Of_Electricity) && $Electricity->Source_Of_Electricity!=''?$Electricity->Source_Of_Electricity:''}}" required />
                              </p>
                          </div>
                          @if($i==1)
                          <div class="col-sm-2 form-group">
                    ...
                    <tr>
                      <td>
                        <div class="row">
                          <div class="col-sm-2 form-group">
                            <label>Total Capacity*</lable>
                              <p><input class="form-control form-control-sm" id="totalcapacity0" onchange="totalCapacity(0)" placeholder="" name="Total_Capacity[]" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Running Capacity*</lable>
                              <p><input class="form-control form-control-sm" id="runningcapacity0" onchange="totalCapacity(0)" placeholder="" name="Running_Capacity[]" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Meter*</lable>
                              <p><input type="number" class="form-control form-control-sm" placeholder="" name="Meter[]" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Sub Meter*</lable>
                              <p><input type="number" class="form-control form-control-sm" placeholder="" name="Sub_Meter[]" required></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <label>Source Of Electricity*</lable>
                              <p><input class="form-control form-control-sm" type="text" placeholder="" name="Source_Of_Electricity[]" required /></p>
                          </div>
                          <div class="col-sm-2 form-group">
                            <button type="button" name="add" id="add9" class="btn btn-success btn-sm mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                          </div>
                  ...
                  <table class="table table-bordered" id="dynamic_field10">
                        ...
                        <div class="row">
                          <div class="col-sm-4 form-group">
                            <label>Generator*</lable>
                              <p><input type="number" class="form-control form-control-sm" placeholder="" name="generator[]" value="{{isset($val->generator) && $val->generator!=''?$val->generator:''}}" required></p>
                          </div>
                          <div class="col-sm-4 form-group">
                            <label>Generator Capacity*</lable>
                              <p><input class="form-control form-control-sm" placeholder="" name="Generator_Capacity[]" value="{{isset($val->Generator_Capacity) && $val->Generator_Capacity!=''?$val->Generator_Capacity:''}}" required></p>
                          </div>
                          @if($j == 1)
                          <div class="col-sm-2 form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        <label>Generator*</lable>
                          <p><input type="number" class="form-control form-control-sm" placeholder="" name="generator[]" required></p>
                      </div>
                      <div class="col-sm-4 form-group">
                        <label>Generator Capacity*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Generator_Capacity[]" required></p>
                      </div>
                      <div class="col-sm-2 form-group">
                        <button type="button" name="add" id="add10" class="btn btn-success btn-sm mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
