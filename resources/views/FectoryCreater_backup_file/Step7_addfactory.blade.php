                ...
                <div class="tab1">
                  <div class="row">
                    <div class="col-sm-10 form-group">
                      <label>Total Warehouse*</lable>
                        <p><input class="form-control form-control-sm" placeholder="Total Warehouse" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) ||(event.charCode == 46))" name="Total_Warehouse" id="total_warehouse" value="{{isset($warehousetotal->Total_Warehouse) && $warehousetotal->Total_Warehouse!=''?$warehousetotal->Total_Warehouse:''}}" required></p>
                    </div>
                  </div>
                  <div id="dynamic_field11">
                    ...
                    <div class="row counttt" id="row{{$i}}">
                      <div class="col-sm-3 form-group">
                        <label>Warehouse Name*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Warehouse_Name[]" value="{{isset($val->Warehouse_Name) && $val->Warehouse_Name!=''?$val->Warehouse_Name:''}}" required></p>
                      </div>
                      <div class="col-sm-3 form-group">
                        <label>Count*</lable>
                          <p><input type="number" class="form-control form-control-sm" placeholder="" name="Count[]" value="{{isset($val->Count) && $val->Count!=''?$val->Count:''}}" required></p>
                      </div>
                      <div class="col-sm-3 form-group">
                        <label>Warehouse Type*</lable>
                          <p><input type="text" class="form-control form-control-sm" placeholder="" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) ||(event.charCode >= 97 && event.charCode <= 122) ||(event.charCode == 32 ))" name="Warehouse_Type[]" value="{{isset($val->Warehouse_Type) && $val->Warehouse_Type!=''?$val->Warehouse_Type:''}}" required></p>
                      </div>
                      @if($i==1)
                    ...
                    <div class="row counttt" id="row">
                      <div class="col-sm-3 form-group">
                        <label>Warehouse Name*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Warehouse_Name[]" required></p>
                      </div>
                      <div class="col-sm-3 form-group">
                        <label>Count*</lable>
                          <p><input type="number" class="form-control form-control-sm" placeholder="" name="Count[]" required></p>
                      </div>
                      <div class="col-sm-3 form-group">
                        <label>Warehouse Type*</lable>
                          <p><input class="form-control form-control-sm" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) ||(event.charCode >= 97 && event.charCode <= 122) ||(event.charCode == 32 ))" placeholder="" name="Warehouse_Type[]" required></p>
                      </div>
                      <div class="col-sm-2 form-group">
                        <button type="button" name="add" id="add11" class="btn btn-success btn-sm mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-sm-10 form-group">
                      <label>Total Room*</lable>
                        <p><input class="form-control form-control-sm" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) ||(event.charCode == 46))" placeholder="Total Room" name="Total_Room" id="total_room" value="{{isset($warehousetotal->Total_Room) && $warehousetotal->Total_Room!=''?$warehousetotal->Total_Room:''}}" required></p>
                    </div>
                  </div>
                  <div id="dynamic_field12">
                    ...
                    <div class="row countts" id="rows{{$j}}">
                      <div class="col-sm-4 form-group">
                        <label>Room Name*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Room_Name[]" value="{{isset($val->Room_Name) && $val->Room_Name!=''?$val->Room_Name:''}}" required></p>
                      </div>
                      <div class="col-sm-4 form-group">
                        <label>Room Count*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Room_Count[]" value="{{isset($val->Room_Count) && $val->Room_Count!=''?$val->Room_Count:''}}" required></p>
                      </div>
                      @if($j==1)
                      <div class="col-sm-2 form-group">
                    ...
                    <div class="row countts">
                      <div class="col-sm-4 form-group">
                        <label>Room Name*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Room_Name[]" required></p>
                      </div>
                      <div class="col-sm-4 form-group">
                        <label>Room Count*</lable>
                          <p><input class="form-control form-control-sm" placeholder="" name="Room_Count[]" required></p>
                      </div>
                      <div class="col-sm-2 form-group">
                        <button type="button" name="add" id="add12" class="btn btn-success btn-sm mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#add11').click(function() {
      ...
      i++;
      var a = '<div class="row counttt" id="row' + i + '" > <div class="col-sm-3 form-group"> <label>Warehouse Name*</lable> <p><input class="form-control form-control-sm" placeholder="" name="Warehouse_Name[]" required></p></div><div class="col-sm-3 form-group"> <label>Count*</lable> <p><input type="number" class="form-control form-control-sm" placeholder="" name="Count[]" required></p></div><div class="col-sm-3 form-group"> <label>Warehouse Type*</lable> <p><input class="form-control form-control-sm" placeholder="" name="Warehouse_Type[]" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) ||(event.charCode >= 97 && event.charCode <= 122) ||(event.charCode == 32 ))"  required></p></div><div class="col-sm-2 form-group"> <a name="remove" onclick="remove(' + i + ')" class="btn btn-danger btn-sm mt-4 btn_remove">X</a> </div></div>';
