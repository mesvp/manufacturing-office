                                ...
                                <div class="tab1">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>GST IN No.</lable>
                                                <div class="field-wrap">
                                                    <select name="gst_no" class="form-select form-select-sm" required>
                                                        <option value="" selected disabled>Select</option>
                                                        @foreach($gst as $val)
                                                        <option value="{{$val->id}}" {{isset($statury->gst_no) && $statury->gst_no==$val->id?'selected':''}}>{{$val->GST_In_no}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>GST IN Certificate Attachement*</lable>
                                                <p><input class="form-control form-control-sm " type="file" name="gst_in_certificate_attachement" value="{{isset($statury->gst_in_certificate_attachement) && $statury->gst_in_certificate_attachement!=''?$statury->gst_in_certificate_attachement:''}}" {{isset($statury->id)&&$statury->id!=''?'':'required'}}></p>
                                                ...
                                                <div class="downloadfile" id="gst_in_certificate_attachement">
                                                    ...
                                                    <p><a href="{{url('../storage/app/public/'.(isset($statury->gst_in_certificate_attachement) && $statury->gst_in_certificate_attachement!=''?$statury->gst_in_certificate_attachement:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Pan No.*</lable>
                                                <div class="field-wrap">
                                                    <select name="pan" class="form-select form-select-sm" required>
                                                        <option value="" selected disabled>Select</option>
                                                        @foreach($pan as $val)
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>PAN Attachement*</lable>
                                                <p><input class="form-control form-control-sm" type="file" name="pan_attachement" {{isset($statury->id)&&$statury->id!=''?'':'required'}}></p>
                                                ...
                                                <div class="downloadfile" id="pan_attachement">
                                                    ...
                                                    <p><a href="{{url('../storage/app/public/'.(isset($statury->pan_attachement) && $statury->pan_attachement!=''?$statury->pan_attachement:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Factory License No.*</lable>
                                                <div class="field-wrap">
                                                    <select name="factory_license_no" class="form-select form-select-sm" required>
                                                        <option value="" selected disabled>Select</option>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Factory License Attachement*</lable>
                                                <p><input class="form-control form-control-sm" type="file" name="factory_license_attachement" {{isset($statury->id)&&$statury->id!=''?'':'required'}}></p>
                                                ...
                                                <div class="downloadfile" id="factory_license_attachement">
                                                    ...
                                                    <p><a href="{{url('../storage/app/public/'.(isset($statury->factory_license_attachement) && $statury->factory_license_attachement!=''?$statury->factory_license_attachement:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Labour License No.*</lable>
                                                <div class="field-wrap">
                                                    <select name="labour_license_no" class="form-select form-select-sm" required>
                                                        <option value="" selected disabled>Select</option>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Labour License Attachement*</lable>
                                                <p><input class="form-control form-control-sm" type="file" name="labour_license_attachement" {{isset($statury->id)&&$statury->id!=''?'':'required'}}></p>
                                                ...
                                                <div class="downloadfile" id="labour_license_attachement">
                                                    ...
                                                    <p><a href="{{url('../storage/app/public/'.(isset($statury->labour_license_attachement) && $statury->labour_license_attachement!=''?$statury->labour_license_attachement:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Pollution Certificate No.*</lable>
                                                <div class="field-wrap">
                                                    <select name="pollution_certificate_no" class="form-select form-select-sm" required>
                                                        <option value="" selected disabled>Select</option>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Pollution Certificate Attachement*</lable>
                                                <p><input class="form-control form-control-sm" type="file" name="pollution_certificate_attachement" {{isset($statury->id)&&$statury->id!=''?'':'required'}}></p>
                                                ...
                                                <div class="downloadfile" id="pollution_certificate_attachement">
                                                    ...
                                                    <p><a href="{{url('../storage/app/public/'.(isset($statury->pollution_certificate_attachement) && $statury->pollution_certificate_attachement!=''?$statury->pollution_certificate_attachement:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
                                                        ...
                                                        <td>
                                                            <div class="field-wrap">
                                                                ...
                                                                <div class="downloadfile" id="add_field_attachement_manually">
                                                                    ...
                                                                    <p><a href="{{url('../storage/app/public/'.(isset($val->add_field_attachement_manually) && $val->add_field_attachement_manually!=''?$val->add_field_attachement_manually:''))}}" target="_blank" download><i class="fa fa-download" aria-hidden="true"></i></a></p>
