    ...
    <div class="app-content">
        <section class="section">
            <div class="addbtn extra">
                <a href="{{url('FactoryCreater/List')}}" class="btn btn-info" style=""> <i class="fa fa-arrow-left"></i> BACK</a>
            ...
            <div class="row">
                                    ...
                                    <div class="col-sm-2 form-group">
                                        <label>Organization*</lable>
                                            <select disabled class="form-select form-select-sm" name="organization" required>
                                                ...
                                                <option value="{{$val->id}}" {{isset($showdata->organization) && $showdata->organization==$val->id?'selected':''}}>{{$val->organization}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="col-sm-2 form-group">
                                        <label>Name Of Unit*</lable>
                                            <select disabled class="form-select form-select-sm" name="name_of_unit" required>
                                                ...
                                                <option value="{{$val->id}}" {{isset($showdata->name_of_unit) && $showdata->name_of_unit==$val->id?'selected':''}}>{{$val->name_of_unit}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="col-sm-2 form-group">
                                    ...
                                    <div class="col-sm-2 form-group">
                                        <label>State*</lable>
                                            <select disabled class="form-select form-select-sm" name="state" id="state" required>
                                                ...
                                                <option value="{{$val->id}}" {{isset($showdata->state) && $showdata->state==$val->id?'selected':''}}>{{$val->name}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="col-sm-2 form-group">
                                        <label>District*</lable>
                                            <select disabled class="form-select form-select-sm" name="district" id="district" required>
                                                <option value="null" selected disabled>Select Option</option>
                                                @foreach($city as $val)
                                                <option value="{{$val->id}}" {{isset($showdata->district) && $showdata->district==$val->id?'selected':''}}>{{$val->city}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                </div>
                                    ...
                                    <div id="dynamic_field13">
                                        ...
                                        <div id="rows{{$i}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 form-group">
                                                    <label>Organization*</lable>
                                                        <p><input disabled class="form-control form-control-sm" placeholder="" name="Organization_Second[{{$i}}]" value="{{isset($val->Organization_Second) && $val->Organization_Second!=''?$val->Organization_Second:''}}" required></p>
                                                </div>
                                                <div class="col-sm-2 form-group">
                                                    <label>Location*</lable>
                ...
                <hr>
                @if($showdata->Approve_status=='OBJECT' && $showdata->userID==auth()->user()->id)
                <form action="{{url('FactoryCreater/approve')}}" method="POST">
                    ...
                    <a href="{{url('FactoryCreater/Fectory_view/'.$nextID)}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                    @else
                    <a href="{{url('FactoryCreater/List')}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                    @endif
                </form>
                @else
                <form action="{{url('FactoryCreater/approve')}}" method="POST">
