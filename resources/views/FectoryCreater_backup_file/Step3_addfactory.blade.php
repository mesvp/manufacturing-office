              ...
              <div class="tabs">
                ...
                <div class="tab1">
                  <div class="row">
                    <div class="col-sm-3 form-group Select2Handle">
                      <label>Land Type*</lable>
                        <select name="land_type" class="form-select form-select-sm js-example-matcher-start" required>
                    ...
                    <div class="col-sm-3 form-group">
                      <label>Land Area(Sq. Ft.)*</lable>
                        <p><input type="number" class="form-control form-control-sm" id="landarea" name="land_area" placeholder="Land Area(Sq. Ft.)" value="{{isset($landbulding->land_area) && $landbulding->land_area!=''?$landbulding->land_area:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Open Area(Sq. Ft.)*</lable>
                        <p><input type="number" class="form-control form-control-sm" id="openarea" name="open_area" placeholder="Open Area(Sq. Ft.)" value="{{isset($landbulding->open_area) && $landbulding->open_area!=''?$landbulding->open_area:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Cover Area(Sq. Ft.)*</lable>
                        <p><input type="number" class="form-control form-control-sm" id="coverarea" name="cover_area" placeholder="Cover Area(Sq. Ft.)" value="{{isset($landbulding->cover_area) && $landbulding->cover_area!=''?$landbulding->cover_area:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Building Area(Sq. Ft.)</lable>
                        <p><input class="form-control form-control-sm" type="number" id="buildingarea" name="building_area" placeholder="Building Area(Sq. Ft.)" value="{{isset($landbulding->building_area) && $landbulding->building_area!=''?$landbulding->building_area:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3 form-group">
                      <label>Building Type*</lable>
                        <p><input class="form-control form-control-sm" name="building_type" placeholder="Building Type" value="{{isset($landbulding->building_type) && $landbulding->building_type!=''?$landbulding->building_type:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Boundary Height(Sq. Ft.)*</lable>
                        <p><input class="form-control form-control-sm" type="number" name="boundary_height" placeholder="Boundary Height(Sq. Ft.)" value="{{isset($landbulding->boundary_height) && $landbulding->boundary_height!=''?$landbulding->boundary_height:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Boundary Width(Sq. Ft.)*</lable>
                        <p><input class="form-control form-control-sm" name="boundary_width" placeholder="Boundary Width(Sq. Ft.)" value="{{isset($landbulding->boundary_width) && $landbulding->boundary_width!=''?$landbulding->boundary_width:''}}" required></p>
                    </div>
                          ...
                          <tr id="rows{{$i}}">
                            ...
                            <td class="forDesign">
                              <div class="field-wrap">
                                <select name="boundary_type[]" class="form-select form-select-sm js-example-matcher-start selecttt" required>
                                  <option value="" selected disabled>Select</option>
                            ...
                            @else
                            <td><a href="javascript:;" onclick="remove({{$i}})" class="btn btn-danger btn btn-sm btn_remove">X</a></td>
                            @endif
                          </tr>
                          @php
                          $i++;
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="field-wrap">
                                ...
                                <input class="form-control form-control-sm" type="file" autocomplete="off" class="form-control form-control-sm" name="attachement0" required />
                              </div>
                            </td>
                            <td><a href="javascript:;" id="add2" class="btn btn-success btn btn-sm"><i class="fa fa-plus" aria-hidden="true"></i></a></td>
                          </tr>
                  ...
                  <div class="row">
                    <div class="col-sm-3 form-group">
                      <label>Window*</lable>
                        <p><input class="form-control form-control-sm" name="window" placeholder="Window" value="{{isset($landbulding->window) && $landbulding->window!=''?$landbulding->window:''}}" required></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label>Gate*</lable>
                        <p><input class="form-control form-control-sm" name="gate" placeholder="Gate" value="{{isset($landbulding->gate) && $landbulding->gate!=''?$landbulding->gate:''}}" required></p>
                    </div>
                  </div>
                  <div class="row">
                          ...
                          <tr id="row{{$i}}">
                            ...
                            <td>
                              <div class="field-wrap"><label style="display:flex;">Add Field Name Manually</label>
                                <input class="form-control form-control-sm" type="text" autocomplete="off" class="form-control form-control-sm" name="add_field_name_manually[]" placeholder="Add Field Name Manually" value="{{isset($val->add_field_name_manually) && $val->add_field_name_manually!=''?$val->add_field_name_manually:''}}" required />
                              </div>
                              <br>
                              <div class="field-wrap"><label style="display:flex;">Enter Manually Details</label>
                                <input class="form-control form-control-sm" type="text" autocomplete="off" class="form-control form-control-sm" name="enter_manually_details[]" placeholder="Enter Manually Details" value="{{isset($val->enter_manually_details) && $val->enter_manually_details!=''?$val->enter_manually_details:''}}" required />
                              </div>
                            </td>
