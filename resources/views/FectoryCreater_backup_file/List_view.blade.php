                            ...
                            <div class="row filter">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="name_of_unit" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($nameOFUnit) && $nameOFUnit==$val->id?'selected':''}}>{{ isset($val->name_of_unit) && $val->name_of_unit!=''?$val->name_of_unit:''}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="District_State" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($district) && $district==$val->id?'selected':''}}>{{ isset($val->city) && $val->city!=''?$val->city:'' }}/{{isset($val->stateData->name) && $val->stateData->name!=''?$val->stateData->name:''}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-2 mb-3">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="GST_No" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($selectedGST) && $selectedGST==$val->id?'selected':''}}>{{ isset($val->GST_In_no) && $val->GST_In_no!=''?$val->GST_In_no:'' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-2 mb-3">
                                    ...
                                    <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{isset($val->org->organization) && $val->org->organization!=''?$val->org->organization:''}}</td>
                                                <td>{{isset($val->unitname->name_of_unit) && $val->unitname->name_of_unit!=''?$val->unitname->name_of_unit:''}}</td>
                                                <td>{{isset($val->districtss->city) && $val->districtss->city!=''?$val->districtss->city:''}}/{{isset($val->statess->name) && $val->statess->name!=''?$val->statess->name:''}}</td>
                                                <td>{{$val->plantsCount}}</td>
                                                <td>{{isset($val->gst->GST_In_no) && $val->gst->GST_In_no!=''?$val->gst->GST_In_no:''}}</td>
