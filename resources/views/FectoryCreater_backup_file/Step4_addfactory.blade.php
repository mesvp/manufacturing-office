              ...
              <div>
                  ...
                  <div class="maindd" id='mainddd'>
                    ...
                    <div id="removemachinepage{{$i}}" class="row">
                      ...
                      <div class="col-sm-11 tab1">
                        <div class="row">
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>Plant Name*</lable>
                              <div class="field-wrap">
                                <select name="Plant_Name[{{$i}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($masterplant as $val)
                                  <option value="{{$val->id}}" {{isset($plantmach->Plant_Name) && $plantmach->Plant_Name==$val->id?'selected':''}}>{{$val->plant_name}}</option>
                                  @endforeach
                                </select>
                              </div>
                          </div>
                          ...
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>Product</lable>
                              <div class="field-wrap">
                                <select name="Product[{{$i}}]" class="form-select form-select-sm js-example-matcher-start" id="product{{$i}}" onclick="product({{$i}})" required>
                                  <option value="" selected disabled>Select</option>
                          ...
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>Sub product</lable>
                              <div class="field-wrap">
                                <select name="Sub_product[{{$i}}]" class="form-select form-select-sm js-example-matcher-start" id="subproduct{{$i}}" onclick="subproduct({{$i}})" required>
                                  <option value="" selected disabled>Select</option>
                          ...
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>Sub Sub product</lable>
                              <div class="field-wrap">
                                <select name="Sub_Sub_product[{{$i}}]" class="form-select form-select-sm js-example-matcher-start" id="subsubproduct{{$i}}" required>
                                  <option value="" selected disabled>Select</option>
                        ...
                        <div class="row">
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>UOM*</lable>
                              <select name="UOM[{{$i}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                <option value="" selected disabled>Select</option>
                                @foreach($uom as $val)
                        ...
                        <table class="table table-bordered" id="dynamic_fieldaddmachine{{$i}}">
                          @if(count($plantmach->machinename)>0)
                          @php
                          $j = 1;
                          @endphp
                          @foreach($plantmach->machinename as $machinenameVal)
                          <tr id="rowaddmachine{{$i}}{{$j}}">
                            <input class="form-control form-control-sm" type="hidden" name="machinenameID[{{$i}}][{{$j}}]" value="{{isset($machinenameVal->id) && $machinenameVal->id!=''?$machinenameVal->id:''}}">
                            <td>
                              <div class="row">
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Machine Name*</lable>
                                    <select name="Machine_Name[{{$i}}][{{$j}}]" id="machinename{{$i}}{{$j}}" onclick="machinename({{$i}},{{$j}})" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($MachineName as $val)
                                      <option value="{{$val->id}}" {{isset($machinenameVal->Machine_Name) && $machinenameVal->Machine_Name==$val->id?'selected':''}}>{{$val->Machine_Name}}</option>
                                      @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                ...
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Machine Code*</lable>
                                    <select name="Machine_Code[{{$i}}][{{$j}}]" id="machinecode{{$i}}{{$j}}" onclick="machinecode({{$i}},{{$j}})" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Machine_Code as $val)
                                      <option value="{{$val->id}}" {{isset($machinenameVal->Machine_Code) && $machinenameVal->Machine_Code==$val->id?'selected':''}}>{{$val->Machine_Code}}</option>
                                      @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Accessories*</lable>
                                    <select name="Accessories[{{$i}}][{{$j}}]" id="accessories{{$i}}{{$j}}" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Accessories as $val)
                                      <option value="{{$val->id}}" {{isset($machinenameVal->Accessories) && $machinenameVal->Accessories==$val->id?'selected':''}}>{{$val->Accessories}}</option>
                                      @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                ...
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Specification*</lable>
                                    <select name="Specification[{{$i}}][{{$j}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Specification as $val)
                                      <option value="{{$val->id}}" {{isset($machinenameVal->Specification) && $machinenameVal->Specification==$val->id?'selected':''}}>{{$val->Specification}}</option>
                                      @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Make & Model*</lable>
                                    <div class="field-wrap">
                                      <select name="Make_Model[{{$i}}][{{$j}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                        <option value="" selected disabled>Select</option>
                                        @foreach($Make_Model as $val)
                                        <option value="{{$val->id}}" {{isset($machinenameVal->Make_Model) && $machinenameVal->Make_Model==$val->id?'selected':''}}>{{$val->Make_Model}}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                </div>
                                @if($j==1)
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <button type="button" id="addmachine{{$i}}" onclick="addmachine({{$i}},{{isset($machineCount) && $machineCount==0?1:$machineCount+1}})" class="btn btn-success btn-sm mt-4 mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                </div>
                                @else
                                <div class="col-sm-3 form-group SelectDesignHandle">
                          ...
                          <div class="row">
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Machine Name*</lable>
                                <select name="Machine_Name[{{$i}}][0]" id="machinename00" onclick="machinename(0,0)" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($MachineName as $val)
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Attachement</lable>
                                <p><input class="form-control form-control-sm" type="file" name="Attachement{{$i}}0"></p>
                            </div>
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Machine Code*</lable>
                                <select name="Machine_Code[{{$i}}][0]" id="machinecode00" onclick="machinecode(0,0)" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Machine_Code as $val)
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Accessories*</lable>
                                <select name="Accessories[{{$i}}][0]" id="accessories00" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Accessories as $val)
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Attachement</lable>
                                <p><input class="form-control form-control-sm" type="file" name="Attachements{{$i}}0"></p>
                            </div>
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Specification*</lable>
                                <select name="Specification[{{$i}}][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Specification as $val)
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Make & Model*</lable>
                                <div class="field-wrap">
                                  <select name="Make_Model[{{$i}}][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                    <option value="" selected disabled>Select</option>
                                    @foreach($Make_Model as $val)
                        ...
                        <table class="table table-bordered" id="dynamic_fieldaddwarnty{{$i}}">
                          @if(count($plantmach->warrnty)>0)
                          @php
                          $k = 1;
                          @endphp
                          @foreach($plantmach->warrnty as $warrnty)
                          <tr id="rowremovewarnty{{$i}}{{$k}}">
                            <input class="form-control form-control-sm" type="hidden" name="warrntyID[{{$i}}][{{$k}}]" value="{{isset($warrnty->id) && $warrnty->id!=''?$warrnty->id:''}}">
                            <td>
                              <div class="row">
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label> Warranty*</lable>
                                    <select name="Warranty[{{$i}}][{{$k}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                ...
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Production Capacity*</lable>
                                    <p><input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control form-control-sm" name="Production_Capacitys[{{$i}}][{{$k}}]" value="{{isset($warrnty->Production_Capacitys) && $warrnty->Production_Capacitys!=''?$warrnty->Production_Capacitys:''}}" required></p>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>UOM*</lable>
                                    <div class="field-wrap">
                                      <select name="UOMs[{{$i}}][{{$k}}]" class="form-select form-select-sm js-example-matcher-start" required>
                                        <option value="" selected disabled>Select</option>
                                        @foreach($uom as $val)
                                ...
                                @if($k==1)
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <button type="button" id="addwarrnty{{$i}}" onclick="addwarnty({{$i}},{{isset($warrantyCount) && $warrantyCount==0?1:$warrantyCount+1}})" class="btn btn-success btn-sm mt-4 mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                </div>
                                @else
                                <div class="col-sm-3 form-group SelectDesignHandle">
                          ...
                          <tr>
                            <td>
                              <div class="row">
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label> Warranty*</lable>
                                    <select name="Warranty[{{$i}}][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Warranty as $val)
                                ...
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>Production Capacity*</lable>
                                    <p><input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control form-control-sm" name="Production_Capacitys[{{$i}}][0]" required></p>
                                </div>
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>UOM*</lable>
                                    <div class="field-wrap">
                                      <select name="UOMs[{{$i}}][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                        <option value="" selected disabled>Select</option>
                                        @foreach($uom as $val)
                            ...
                            <label>Others</lable>
                              <table class="table table-bordered" id="dynamic_fieldaddother{{$i}}">
                                ...
                                <tr id="rowaddothers{{$i}}{{$l}}">
                                  <input class="form-control form-control-sm" type="hidden" name="otherID[{{$i}}][{{$l}}]" value="{{isset($other->id) && $other->id!=''?$other->id:''}}">
                                  <td>
                                    <div class="row">
                      ...
                      @if($i==1)
                      <div class="col-sm-1">
                        <a href="javascript:;" id="addmachinepage" onclick="addmachinepage({{isset($plantCount) && $plantCount==0?1:$plantCount+1}})" class="btn btn-success btn-sm mt-4"><i class="fa fa-plus" aria-hidden="true"></i></a>
                      </div>
                      @else
                      <div class="col-sm-1">
                      ...
                      <div class="col-sm-11 tab1">
                        <div class="row">
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>Plant Name*</lable>
                              <div class="field-wrap">
                                <select name="Plant_Name[0]" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($masterplant as $val)
                        ...
                        <div class="row">
                          <div class="col-sm-3 form-group SelectDesignHandle">
                            <label>UOM*</lable>
                              <select name="UOM[0]" class="form-select form-select-sm js-example-matcher-start" required>
                                <option value="" selected disabled>Select</option>
                                @foreach($uom as $val)
                                <option value="{{$val->id}}">{{$val->UOMs}}</option>
                                @endforeach
                        ...
                        <table class="table table-bordered" id="dynamic_fieldaddmachine0">
                          <div class="row">
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Machine Name*</lable>
                                <select name="Machine_Name[0][0]" id="machinename00" onclick="machinename(0,0)" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($MachineName as $val)
                                  <option value="{{$val->id}}">{{$val->Machine_Name}}</option>
                                  @endforeach
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Machine Code*</lable>
                                <select name="Machine_Code[0][0]" id="machinecode00" onclick="machinecode(0,0)" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Machine_Code as $val)
                                  <option value="{{$val->id}}">{{$val->Machine_Code}}</option>
                                  @endforeach
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Accessories*</lable>
                                <select name="Accessories[0][0]" id="accessories00" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Accessories as $val)
                                  <option value="{{$val->id}}">{{$val->Accessories}}</option>
                                  @endforeach
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Specification*</lable>
                                <select name="Specification[0][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($Specification as $val)
                                  <option value="{{$val->id}}">{{$val->Specification}}</option>
                                  @endforeach
                            ...
                            <div class="col-sm-3 form-group SelectDesignHandle">
                              <label>Make & Model*</lable>
                                <div class="field-wrap">
                                  <select name="Make_Model[0][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                    <option value="" selected disabled>Select</option>
                                    @foreach($Make_Model as $val)
                                    <option value="{{$val->id}}">{{$val->Make_Model}}</option>
                                    @endforeach
                          ...
                          <tr>
                            <td>
                              <div class="row">
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label> Warranty*</lable>
                                    <select name="Warranty[0][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Warranty as $val)
                                      <option value="{{$val->id}}">{{$val->Warranty}}</option>
                                      @endforeach
                                ...
                                <div class="col-sm-3 form-group SelectDesignHandle">
                                  <label>UOM*</lable>
                                    <div class="field-wrap">
                                      <select name="UOMs[0][0]" class="form-select form-select-sm js-example-matcher-start" required>
                                        <option value="" selected disabled>Select</option>
                                        @foreach($uom as $val)
                                        <option value="{{$val->id}}">{{$val->UOMs}}</option>
                                        @endforeach
                ...
                <div style="overflow:auto;">
                  <div style="float:right;">
                    ...
                    <a href="" class="btn btn1 float-right" style="margin: 5px; display:{{isset($plantmach->id) && $plantmach->id != ''?'none':'block'}}">Clear All</a>             
