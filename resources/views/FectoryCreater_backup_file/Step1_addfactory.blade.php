                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label>Organization*</lable>
                                                <select class="form-select form-select-sm" name="organization" required>
                                                    ...
                                                    <option value="{{$val->id}}" {{isset($addresssdetails->organization) && $addresssdetails->organization==$val->id?'selected':''}}>{{$val->organization}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <label>Name Of Unit*</lable>
                                                <select class="form-select form-select-sm" name="name_of_unit" required>
                                                    ...
                                                    <option value="{{$val->id}}" {{isset($addresssdetails->name_of_unit) && $addresssdetails->name_of_unit==$val->id?'selected':''}}>{{$val->name_of_unit}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                        <div class="col-sm-4 form-group">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label>State*</lable>
                                                <select class="form-select form-select-sm" name="state" id="state" required>
                                                    ...
                                                    <option value="{{$val->id}}" {{isset($addresssdetails->state) && $addresssdetails->state==$val->id?'selected':''}}>{{$val->name}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <label>District*</lable>
                                                <select class="form-select form-select-sm" name="district" id="district" required>
                                                    <option value="" selected disabled>Select Option</option>
                                                    @foreach($city as $val)
                                                    <option value="{{$val->id}}" {{isset($addresssdetails->district) && $addresssdetails->district==$val->id?'selected':''}}>{{$val->city}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                    </div>
