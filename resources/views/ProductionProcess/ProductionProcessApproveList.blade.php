...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Production Process Approve Page</li>
            </ol>
            <div class="row">
                <div class="container">
                    <form action="{{url('ProductionProcess/Filter-approve')}}" method="POST">
                        @csrf
                        <div class="row filter">
                            ...
                            <div class="col-2 mt-4">
                                ...
                                <a href="{{url('ProductionProcess/ProductionProcessApproveList')}}"><button type="button" class="btn btn-secondary"><i class="fa fa-refresh"></i></button></a>
                            </div>
                        ...
                        <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="maindffd">
                                        <a href="{{url('ProductionProcess/view-approve/'.$val->id.'/ALL')}}" class="btn btn-primary">View</a>
                                    </td>
                                </tr>
                                @endforeach
                                @php
