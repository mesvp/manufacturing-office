...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Production Process View Page</li>
            </ol>
            <div class="addbtn">
                <a href="{{url('ProductionProcess/ExportData')}}"><i class='fas fa-file-excel'></i></a>
                @if(isset($EXT[19]['inputer']))
                <a href="{{url('ProductionProcess/ProductionProcess')}}"><button class="btn btn-info">Add Production Process</button></a>
                @endif
            </div>
            <div class="row">
                <div class="container">
                    <form action="{{url('ProductionProcess/filtered')}}" method="POST">
                        @csrf
                        <div class="row filter">
                            ...
                            <div class="col-2 mb-3">
                                ...
                                <select name="Sub_Product" class="form-select form-select-sm js-example-matcher-start">
                                    <option value="" disabled selected>Select</option>
                                    <option value="all" {{isset($SubProductss) && $SubProductss === 'all' ? 'selected' : '' }}>All</option>
                                    @foreach($Sub_Product as $val)
                                    <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($SubProductss) && $SubProductss==$val->id?'selected':''}}>{{ isset($val->sub_product) && $val->sub_product!=''?$val->sub_product:''}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-2 mb-3">
                                ...
                                <select name="Sub_Sub_Product" class="form-select form-select-sm js-example-matcher-start">
                                    <option value="" disabled selected>Select</option>
                                    <option value="all" {{isset($SubSubProductss) && $SubSubProductss === 'all' ? 'selected' : '' }}>All</option>
                                    @foreach($Sub_Sub_Product as $val)
                                    <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($SubSubProductss) && $SubSubProductss==$val->id?'selected':''}}>{{ isset($val->sub_sub_product) && $val->sub_sub_product!=''?$val->sub_sub_product:''}}</option>
                                    @endforeach
                                </select>
                            </div> --}}
                            <div class="col-2 mb-3">
                                ...
                                <select name="Raw_Material" class="form-select form-select-sm js-example-matcher-start">
                                    ...
                                    <option value="{{ isset($val->RawMaterial->id) && $val->RawMaterial->id!=''?$val->RawMaterial->id:'' }}" {{isset($RawMaterialss) && $RawMaterialss==$val->RawMaterial->id?'selected':''}}>{{ isset($val->RawMaterial->material_name) && $val->RawMaterial->material_name!=''?$val->RawMaterial->material_name:''}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-2 mb-3">
                            ...
                            <div class="col-2 mt-4">
                                ...
                                <a href="{{url('ProductionProcess/ProductionProcessList')}}"><button type="button" class="btn btn-secondary"><i class="fa fa-refresh"></i></button></a>
                            </div>
                    ...
                    <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link count active" id="Alls" data-mdb-toggle="tab" href="#All" role="tab" aria-controls="All" aria-selected="true">All <span class="countss">{{count($ProductionProcess)}}</span></a>
                        </li>
                        <li class="nav-item" role="presentation">
                            ...
                            <div class="table-responsive">
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sesionarr=[];
                                        @endphp
                                        @foreach($ProductionProcess as $key => $val)
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td>{{isset($val->Sub_Product->sub_product) && $val->Sub_Product->sub_product!=''?$val->Sub_Product->sub_product:''}}</td>
                                            <td>{{isset($val->Sub_Sub_Product->sub_sub_product) && $val->Sub_Sub_Product->sub_sub_product!=''?$val->Sub_Sub_Product->sub_sub_product:''}}</td> --}}
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/ALL')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                                @endif
                                                @else
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-warning">Draft</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/APPROVE')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/PENDING')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/HOLD')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/RECHECK')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/OBJECT')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
                                ...
                                <table id="" class="table table-sm table-striped table-bordered example" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="maindffd">
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('ProductionProcess/ProductionProcess_View/'.$val->id.'/REJECT')}}" class="btn btn-primary">View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[19]['inputer']))
                                                <a href="{{url('ProductionProcess/ProductionProcess/'.$val->id)}}" class="btn btn-secondary">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('ProductionProcess/Release_Hold/'.$val->id)}}" class="btn btn-secondary">Release</a>
