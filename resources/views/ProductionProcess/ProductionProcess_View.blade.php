        ...
        <section class="section">
            ...
            <div class="row">
                ...
                <form action="{{url('ProductionProcess/approve')}}" method="POST">
                    ...
                    <a href="{{url('ProductionProcess/ProductCategory_View/'.$nextID)}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                    @else
                    <a href="{{url('ProductionProcess/ProductionProcessList')}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                    @endif
                </form>
                @else
                <form action="{{url('ProductionProcess/approve')}}" method="POST">
