...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">BOM View Page</li>
            </ol>
            <div class="addbtn">
                <a href="{{url('BOM/ExportData')}}"><i class='fas fa-file-excel'></i></a>
                @if(isset($EXT[11]['inputer']))
                <a href="{{url('BOM/BOM')}}"><button class="btn btn-info">Add BOM</button></a>
                @endif
            </div>
            <div class="row">
                <div class="container">
                    <form action="{{url('BOM/filtered')}}" method="POST">
                        @csrf
                        <div class="row filter">
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                <label for="" class="form-label">BOM Name</label>
                                <select name="BOM_Name" class="form-select form-select-sm js-example-matcher-start">
                                    <option value="" disabled selected>Select</option>
                                    <option value="all" {{isset($BOMNames) && $BOMNames === 'all' ? 'selected' : '' }}>All</option>
                                    <?php $RepeatData = []; ?>
                                    @foreach($DropdownData as $val)
                                    <?php
                                    $BOMName = isset($val->BOM_Name) && $val->BOM_Name != '' ? $val->BOM_Name : '';
                                    if (!empty($BOMName) && !in_array($BOMName, $RepeatData)) {
                                        $RepeatData[] = $BOMName;
                                    ?>
                                        <option value="{{ $BOMName }}" {{isset($BOMNames) && $BOMNames==$BOMName?'selected':''}}>{{ $BOMName }}</option>
                                    <?php } ?>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                <label for="" class="form-label">BOM Code</label>
                                <select name="BOM_Code" class="form-select form-select-sm js-example-matcher-start">
                                    <option value="" disabled selected>Select</option>
                                    <option value="all" {{isset($BOMCodes) && $BOMCodes === 'all' ? 'selected' : '' }}>All</option>
                                    <?php $RepeatData = []; ?>
                                    @foreach($DropdownData as $val)
                                    <?php
                                    $BOMCode = isset($val->BOM_Code) && $val->BOM_Code != '' ? $val->BOM_Code : '';
                                    if (!empty($BOMCode) && !in_array($BOMCode, $RepeatData)) {
                                        $RepeatData[] = $BOMCode;
                                    ?>
                                        <option value="{{ $BOMCode }}" {{isset($BOMCodes) && $BOMCodes==$BOMCode?'selected':''}}>{{ $BOMCode }}</option>
                                    <?php } ?>
                                    @endforeach
                                </select>
                            </div>
                            {{-- <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                ...
                                <select name="Organization" class="form-select form-select-sm js-example-matcher-start">
                                    ...
                                    <option value="{{ isset($val->id) && $val->id!=''?$val->id:'' }}" {{isset($Organizations) && $Organizations==$val->id?'selected':''}}>{{ isset($val->organization) && $val->organization!=''?$val->organization:''}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                ...
                                <select name="HSN_Code" class="form-select form-select-sm js-example-matcher-start">
                                    ...
                                    @foreach($DropdownData as $val)
                                    <?php
                                    $HSNCode = isset($val->HSN_Code_FG) && $val->HSN_Code_FG != '' ? $val->HSN_Code_FG : '';
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                ...
                                <select name="UOM" class="form-select form-select-sm js-example-matcher-start">
                                    ...
                                    @foreach($DropdownData as $val)
                                    <?php
                                    $UOMCode = isset($val->RawMaterial->UOM) && $val->RawMaterial->UOM != '' ? $val->RawMaterial->UOM : '';
                            ...
                            {{-- <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mb-2">
                                <label for="" class="form-label">UOM(FG)</label>
                                <select name="UOM" class="form-select form-select-sm js-example-matcher-start">
                                    <option value="" disabled selected>Select</option>
                                    <option value="all" {{isset($UOMss) && $UOMss === 'all' ? 'selected' : '' }}>All</option>
                                    <?php $RepeatData = []; ?>
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 mt-3">
                                ...
                                <a href="{{url('BOM/BOMList')}}"><button type="button" class="btn btn-secondary btn-sm"><i class="fa fa-refresh"></i></button></a>
                            </div>
                                ...
                                <div class="FilterButtonnn">
                                    <div class="raone">
                                        ...
                                        <div class="ukom" id="myFilter">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="BOM_Name" value="BOM Name" onclick="filterTable(this)">
                                                <label class="form-check-label" for="BOM_Name">BOM Name</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="BOM_Code" value="BOM Code" onclick="filterTable(this)">
                                                <label class="form-check-label" for="BOM_Code">BOM Code</label>
                                            </div>
                                            {{-- <div class="form-check">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="UOM" value="UOM(FG)" onclick="filterTable(this)">
                                                <label class="form-check-label" for="UOM">UOM(FG)</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="Total Amount" value="Total Amount" onclick="filterTable(this)">
                 ...
                 <ul class="nav nav-pills" id="ex1" role="tablist">
                    <li class="nav-item" role="presentation">
                            <a class="nav-link count active p-2" id="Alls" data-mdb-toggle="tab" href="#All" role="tab" aria-controls="All" aria-selected="true">All <span class="countss">{{count($BOM_Data)}}</span></a>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="ex1-content">
                                ...
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="th-sm">BOM Name</th>
                                            <th class="th-sm">BOM Code</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{isset($val->BOM_Name) && $val->BOM_Name!=''?$val->BOM_Name:''}}</td>
                                            <td>{{isset($val->BOM_Code) && $val->BOM_Code!=''?$val->BOM_Code:''}}</td>
                                            {{-- <td>{{isset($val->Organizationss->organization) && $val->Organizationss->organization!=''?$val->Organizationss->organization:''}}</td>
                                            <td>{{isset($val->Manufacturing_Unitss->Manufacturing_unit) && $val->Manufacturing_Unitss->Manufacturing_unit!=''?$val->Manufacturing_Unitss->Manufacturing_unit:''}}</td>
                                            <td>{{isset($val->plant_namess->plant_name) && $val->plant_namess->plant_name!=''?$val->plant_namess->plant_name:''}}</td>
                                            <td>{{isset($val->Categoryss->category) && $val->Categoryss->category!=''?$val->Categoryss->category:''}}</td>
                                            <td>{{isset($val->Productss->product) && $val->Productss->product!=''?$val->Productss->product:''}}</td> --}}
                                            <td>{{isset($val->RawMaterial->material_name) && $val->RawMaterial->material_name!=''?$val->RawMaterial->material_name:''}}</td>
                                            <td>{{isset($val->HSN_Code_FG) && $val->HSN_Code_FG!=''?$val->HSN_Code_FG:''}}</td>
                                            <td>{{isset($val->RawMaterial->UOM) && $val->RawMaterial->UOM!=''?$val->RawMaterial->UOM:''}}</td>
                                            <td>{{isset($val->All_Total_Amount) && $val->All_Total_Amount!=''?$val->All_Total_Amount:''}}</td>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/ALL')}}" class="btn btn-primary btn-sm"> <i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-sm btn-warning mt-1"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                                                @endif
                                                @else
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-warning btn-sm">Draft</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Approved" role="tabpanel" aria-labelledby="Approveds">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/APPROVE')}}" class="btn btn-primary btn-sm"> <i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                                                @endif
                                                @else
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Pending" role="tabpanel" aria-labelledby="Pendings">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/PENDING')}}" class="btn btn-primary btn-sm"> <i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Hold" role="tabpanel" aria-labelledby="Holds">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/HOLD')}}" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Recheck" role="tabpanel" aria-labelledby="Rechecks">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/RECHECK')}}" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Object" role="tabpanel" aria-labelledby="Objects">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/OBJECT')}}" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
                        ...
                        <div class="fade ml-0 mt-1 show tab-pane" id="Reject" role="tabpanel" aria-labelledby="Rejects">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered example" style="width:100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(isset($val->status) && $val->status!=1)
                                                <a href="{{url('BOM/BOM_View/'.$val->id.'/REJECT')}}" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i> View</a>
                                                @if($val->Approve_status == 'RECHECK' && isset($EXT[11]['inputer']))
                                                <a href="{{url('BOM/BOM/'.$val->id)}}" class="btn btn-secondary btn-sm">Edit</a>
                                                @elseif($val->HoldStatus > 0)
                                                <a href="{{url('BOM/Release_Hold/'.$val->id)}}"><button type="button" class="btn btn-secondary btn-sm">Release</button></a>
...
<script>
    ...
    function checkBoxess() {
        ...
        fetch("{{ url('BOM/getCheckBoxData') }}?ID=" + tableID, {
                method: 'GET',
            })
...
<script>
                ...
                response.forEach(function(lead) {
                    if (lead.action === 'HOLD' && lead.status === 1) {
                        ...
                        if (holdDate < currentDate) {
                            UpdateStatus(lead.BOM_id, lead.userID);
                        }
                    }
                });
            },
    ...
    function UpdateStatus(BOM_id, userID) {
        $.ajax({
            url: "{{ url('BOM/UpdateStatus') }}",
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
            ...
            success: function(response) {
                $('#statuss' + BOM_id).html('<span style="color: #FF9000;">Pending</span>');
            }
        });
    }
</script>
