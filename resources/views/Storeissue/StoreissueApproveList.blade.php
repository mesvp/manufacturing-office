...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Store Issue View Page</li>
            </ol>
            <!-- <div class="addbtn">
            ...
            <div class="row">
                <div class="container">
                <form action="https://maestrossoftware.com/public/orderRequirement/orderRequirementApproveList" method="POST">
                        <input type="hidden" name="_token" value="A9qfiuP6svP4pSXAHI0CkJUfY7KXJqUfE0TiXaHR">                        <div class="row filter">
                    ...
                    <!-- <div class="row">
                        <div class="col-sm-6">
                            <div class="">
                                <button type="button" class="btn btn-outline-default materialbtn" id-data="MaterialIssuePending">Material Issue Pending</button>
                                <button type="button" class="btn btn-primary btn-outline-default materialbtn" id-data="MaterialIssueClosed">Material Issue Closed</button>
                                <button type="button" class="btn btn-primary btn-outline-default materialbtn" id-data="MaterialIssuedetail">Material Issue detail</button>
                            </div>
                        </div>
                    </div> -->
                    <br>
                        ...
                        <table id="" class="table table-striped table-bordered example" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('Storeissue/AddStoreissue/'.$val->id)}}/App"><button type="button" class="btn btn-primary">View</button></a>
                                        <a href="{{url('Storeissue/ViewStoreissueApprover/'.$val->id)}}"><button type="button" class="btn btn-success">Material Issue</button></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <!-- <div class="table-responsive MaterialIssue" style="display: none;" id="MaterialIssueClosed">
                        <table id="" class="table table-striped table-bordered example" style="width:100%">
                            <thead>
                                <tr>
                                    <th class="th-sm">SL. No.</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$val->Creater->name??'' }}</td>
                                    <td>{{$val->Request_No??'' }}</td>
                                    <td>{{$val->Work_Order_No??'' }}</td>
                                    <td>{{$val->Organization->organization ?? '' }}</td>
                                    <td>{{$val->Manufacturing->Manufacturing_unit ?? '' }}</td>
                                    <td>{{$val->Plant_name->plant_name ?? '' }}</td>
                                    <td>{{$val->Godown_Name->Godown_Name ?? '' }}</td>
                                    <td>{{$val->created_at ?? '' }}</td>
                                    <td id="statuss{{$val->id}}">
                    ...
                    <!-- <div class="table-responsive MaterialIssue" id="MaterialIssuedetail" style="display: none;">
                        <table id="" class="table table-striped table-bordered example" style="width:100%">
                            <thead>
                                <tr>
                                    <th class="th-sm">SL. No.</th>
...
<script>
    ...
    $(".materialbtn").click(function(){
        ...
        $(".materialbtn").addClass('btn-primary');
