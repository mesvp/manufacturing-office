                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <a href="#" class="btn btn-outline-default materialbtn" id-data="MaterialIssuePending">Material Issue Pending</a>
                            <a href="{{url('Storeissue/StoreissueListClosed')}}" class="btn btn-primary btn-outline-default materialbtn" id-data="MaterialIssueClosed">Material Issue Closed</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="statuss{{$val->id}}">
                                                <?php 
                                                     $mat_stock = App\Models\Storeissue\StoreIssueApprovedMaterial::where('Store_Requistion_id', $val->id)->count(); 
                                                    ?>
                                                @if($mat_stock == "0")
                                                <span style="color: #1335fa;">Pending</span>
                                                @else
                                                <span style="color: #FF9000;">Inprogress</span>
                                                @endif
                                               
                                            </td>
                                            <td>
                                                <a href="{{url('Storeissue/AddStoreissue/'.$val->id)}}"><button type="button" class="btn btn-primary">View</button></a>
                                                 <a href="{{url('Storeissue/ViewStoreissue/'.$val->id)}}"><button type="button" class="btn btn-success">Material Issue
                                                        </button></a>
                                            </td>
                                        </tr>
                                        @endforeach
