                    ...
                    <div class="border-bottom pb-2 row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="addbtn extra p-0">
                                 <a href="#" class="btn btn-info mr-1 btn-sm"> <i class="fa fa-arrow-left"></i></a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        ////////////////////////
        $.post("{{url('Production/action/')}}/{{$type??0}}", {
            id: id
        }, function(data) {
            $("#action").html(data);
        });
        /////////////////
        $.post("{{url('Production/trail')}}", {
            id: id
        }, function(data) {
            $("#trail").html(data);
        });
    ...
    function materialdata() {
        ...
        $.ajax({
            url: "{{url('Production/MaterialData_view')}}",
            type: 'POST',
            data: {
                productionID: '{{$id??""}}',
                MaterialId: MaterialId,
