            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-rchk" aria-controls="navs-profit-id" aria-selected="false">
                            <i class="mdi mdi-cash-multiple mdi-20px me-1"></i>Recheck
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-hold" aria-controls="navs-profit-id" aria-selected="false">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0"><span class="text-muted fw-light">Factory /</span> Production Approval List</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{url('production-lineup/production-setup/approval-list')}}"><button type="button" class="btn btn-outline-success">Refresh</button></a>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="tab-content p-0">
                            <!-- PENDING -->
                            <div class="tab-pane fade active show" id="navs-pendingforapv" role="tabpanel">
                                <div class="">
                                    <table class="d-block dataTable no-footer table table-bordered table-responsive text-nowrap w-100" id="example2">
                                            ...
                                            @foreach ($AllLists as $key => $pendDataList)
                                                ...
                                                @if ($pendDataList->status == 0 && in_array($empId, $approverList))
                                                    <tr>
                                                        ...
                                                        <td>{{ $pendDataList->createdByName }}</td>
                                                        <td>{{ date('d-m-Y H:i:s', strtotime($pendDataList->created_at)) }}</td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    ...
                                                                    <li><a href="{{ url('production-lineup/production-setup/view-details/' . $pendDataList->batchNo .'?menu=production-setup-approval') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if (in_array($empId, $approverList) && $pendDataList->status == 0)
                                                                        <li><a href="{{ url('production-lineup/production-setup/approve/' . $pendDataList->batchNo .'?menu=production-setup-approval') }}"
                                                                                class="dropdown-item"><i
                            ...
                            <!-- RECHECK -->
                            <div class="tab-pane fade" id="navs-rchk" role="tabpanel">
                                <div class="">
                                    <table class="d-block dataTable no-footer table table-bordered table-responsive text-nowrap w-100" id="example3">
                                        <thead class="table-secondary">
                                            <tr>
                                                <td>SL No</td>
                                                <td>Batch No.</td>
                                            ...
                                            @foreach ($AllLists as $key => $recheckDataList)
                                                @if ($recheckDataList->status == 2 && $empId == $recheckDataList->actionBy)
                                                    <tr>
                                                        ...
                                                        <td>{{ $recheckDataList->createdByName }}</td>
                                                        <td>{{ date('d-m-Y H:i:s', strtotime($recheckDataList->created_at)) }}</td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $person = '';
                                                                foreach ($approverDetails as $approver) {
                                                                    if ($recheckDataList->stage == $approver->stage_id) {
                                                                        $person = $person . $approver->Approver . ',';
                                                                        $approverList[] = $approver->person_id;
                                                                    }
                                                                }
                                                                if ($recheckDataList->status == 1) {
                                                                    echo 'Approved By ' . $recheckDataList->actionByName;
                                                                } elseif ($recheckDataList->status == 2) {
                                                                    echo 'Recheck By ' . $recheckDataList->actionByName;
                                                                } elseif ($recheckDataList->status == 3) {
                                                                    echo 'Hold By ' . $recheckDataList->actionByName;
                                                                } elseif ($recheckDataList->status == 4) {
                                                                    echo 'Rejected By ' . $recheckDataList->actionByName;
                                                                } else {
                                                                    echo 'Pending with - ' . rtrim($person, ',');
                                                                }
                                                            @endphp
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ url('production-lineup/production-setup/view-details/' . $recheckDataList->batchNo .'?menu=production-setup-approval') }}"
                            ...
                            <!-- HOLD -->
                            <div class="tab-pane fade" id="navs-hold" role="tabpanel">
                                <div class="">
                                    <table class="d-block dataTable no-footer table table-bordered table-responsive text-nowrap w-100" id="example4">
                                        <thead class="table-secondary">
                                            <tr>
                                                <td>SL No</td>
                                                <td>Batch No.</td>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($AllLists as $key => $holdDataList)
                                                ...
                                                @endphp
                                                @if ($holdDataList->status == 3 && $empId == $holdDataList->actionBy && in_array($empId, $approverList))
                                                    <tr>
                                                        <td>{{ $holdCount++ }}</td>
                                                        ...
                                                        <td>{{ $holdDataList->createdByName }}</td>
                                                        <td>{{ date('d-m-Y H:i:s', strtotime($holdDataList->created_at)) }}</td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    ...
                                                                    <li><a href="{{ url('production-lineup/production-setup/view-details/' . $holdDataList->batchNo .'?menu=production-setup-approval') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if ($holdDataList->actionBy == $empId && $holdDataList->status == 3)
                                                                        <li><a href="{{ url('production-lineup/production-setup/approve/' . $holdDataList->batchNo .'?menu=production-setup-approval') }}"
                                                                                class="dropdown-item"><i
                                                                                    class="mdi mdi-check"></i> Approval
                                                                                Action</a></li>
                                                                    @endif
