...
@section('content')
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card-header d-flex justify-content-between align-items-center py-2">
            <h5 class="mb-0">EL & QC Damage Detailed Report :</h5>
            <div class="text-end">
                <a href="{{ url('production-lineup/el_qc_damage-excel-export') . '?' . http_build_query(request()->all()) }}"
            ...
            <div class="card-body">
                ...
                <form>
                  <div class="col-md-12 row">
                      ...
                      <div class="col-md-3 mb-1 mt-4" style="text-align:right;">
                          ...
                          <a href="{{ url('production-lineup/el_qc-passed') }}"><button type="button"
                ...
                <div class="table-responsive">
                    <table class="dataTable no-footer table table-bordered table-responsive text-nowrap w-100"
                        ...
                        <tbody>
                            @foreach ($AllELQCDamageLists as $item)
                                <tr>
                                    <td>{{ $loop->iteration + ($AllELQCDamageLists->currentPage() - 1) * $AllELQCDamageLists->perPage() }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('el-qc-view', ['id' => $item->elqc_id]) }}?page=VIEW"
