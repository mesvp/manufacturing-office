    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('production-lineup/laminator-op/update/' . $e->fqc_id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="rwrk_pg" value="{{ request()->page }}">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label class="form-label">Barcode No.</label>
                            <input class="form-control" id="bushing_no" value="{{ $e->fqc_barcode ?? '-' }}"
                                readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Batch No</label>
                            <input class="form-control" id="batchno" value="{{ $e->fqc_batchNo ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Date</label>
                            <input class="form-control" id="date" value="{{ $e->fqc_date ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Time</label>
                            <input class="form-control" id="time" value="{{ $e->fqc_time ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" id="plant" value="{{ $e->fqc_plant ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Operator</label>
                            <input class="form-control" id="operator"
                                value="{{ $e->operator_name ?? ($e->fqc_operator ?? '-') }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Incharge</label>
                            <input class="form-control" id="incharge"
                                value="{{ $e->incharge_name ?? ($e->fqc_incharge ?? '-') }}" readonly>
                        </div>
                    </div>
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        ...
                                        <td><input type="text" id="barcodeInput2" class="form-control" name="barCode"
                                                value="{{ $e->fqc_barcode }}" placeholder="Fetch No."
