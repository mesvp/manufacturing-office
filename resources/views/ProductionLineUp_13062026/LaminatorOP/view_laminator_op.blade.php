    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                <h5 class="mb-0">Laminator OP — Details</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('production-lineup/laminator-op/update/' . $e->laminator_id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="rwrk_pg" value="{{ request()->page }}">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label class="form-label">Bushing No</label>
                            <input class="form-control" id="bushing_no" value="{{ $e->laminator_elqcNo ?? '-' }}"
                                readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Batch No</label>
                            <input class="form-control" id="batchno" value="{{ $e->laminator_batchNo ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Date</label>
                            <input class="form-control" id="date" value="{{ $e->laminator_date ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Time</label>
                            <input class="form-control" id="time" value="{{ $e->laminator_time ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" id="plant" value="{{ $e->laminator_plant ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Operator</label>
                            <input class="form-control" id="operator"
                                value="{{ $e->operator_name ?? ($e->laminator_operator ?? '-') }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Incharge</label>
                            <input class="form-control" id="incharge"
                                value="{{ $e->incharge_name ?? ($e->laminator_incharge ?? '-') }}" readonly>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mt-4" id="barcodeteble">
                            <table class="d-block d-xxl-table table table-border table-responsive text-nowrap w-100">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td>Cycle Sl. No.</td>
                                        <td colspan="2"><input type="number" class="form-control" name="cycleNo" placeholder="Cycle Sl. No."
                                                value="{{ $e->laminator_cycle_no }}" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>RFID</td>
                                        ...
                                        <td><input type="text" class="form-control" name="rfid"
                                                value="{{ $e->laminator_rfid }}" placeholder="Fetch No." readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Bar Code</td>
                                        ...
                                        <td><input type="text" id="barcodeInput2" class="form-control" name="barCode"
                                                value="{{ $e->laminator_barcode }}" placeholder="Fetch No."
