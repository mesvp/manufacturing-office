...
@section('content')
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestPending" aria-controls="pending-list" aria-selected="false">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Glass Feeding Request</h5>
                        <div class="text-end">
                            <a href="{{ route('glass-feeding-add') }}"
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{ url('production-lineup/glass-feeding') }}"><button type="button"
                                                    ...
                                                    <td>
                                                        @if (
                                                            ...
                                                            <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('glass-feeding-form-update', ['id' => $allDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                        @endif
                                                        <!--@if ($allDataList->status == 2 && $allDataList->created_by == $empId)
    -->
                                                        <!--    <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"-->
                                                        <!--        href="{{ route('glass-feeding-form-update', ['id' => $allDataList->id]) }}"-->
                                                        <!--        role="button"><i class="mdi mdi-pencil"></i> Edit</a>-->
    ...
    @endif-->
                                                        <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                            href="{{ url('production-lineup/glass-feeding-view/' . $allDataList->id) }}"
                                                            role="button">
                                            ...
                                            @foreach ($allList as $key => $allDataList)
                                                @if ($allDataList->status == 0)
                                                    <tr>
                                                        ...
                                                        <td>{{ date('d-m-Y H:i:s', strtotime($allDataList->created_at)) }}</td>
                                                        <td>
                                                            @if ($allDataList->appr_process == 0 && $allDataList->status == 0 && $allDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                    href="{{ route('glass-feeding-form-update', ['id' => $allDataList->id]) }}"
                                                                    role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                            @endif
                                                ...
                                                @if ($allDataList->status == 2)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!--@if ($allDataList->appr_process == 0 && $allDataList->created_by == $empId)
    -->
                                                            <!--  <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"-->
                                                            <!--      href="{{ route('glass-feeding-form-update', ['id' => $allDataList->id]) }}"-->
                                                            <!--      role="button"><i class="mdi mdi-pencil"></i> Edit</a>-->
    ...
    @endif-->
                                                            ...
                                                            @if ($allDataList->appr_process == 1 && $allDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                    href="{{ route('glass-feeding-form-update', ['id' => $allDataList->id]) }}"
                                                                    role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                            @endif
