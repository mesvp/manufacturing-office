    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                <h5 class="mb-0">90degree QC — View Details</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('production-lineup/laminator-op/update/' . $e->ninetydeg_id) }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" id="batchno" value="{{ $e->ninetydeg_batchNo ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
