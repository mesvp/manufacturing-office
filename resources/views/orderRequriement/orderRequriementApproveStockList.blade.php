...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Order Requriement Sales Approve Page</li>
            </ol>
            <div class="addbtn">
            ...
            <div class="row">
                <div class="container">
                    ...
                    <div class="" id="main_btn_uddhan">
                        <a href="{{url('orderRequirement/orderRequirementApproveStockList')}}" type="button" class="btn btn-default" id="stock">Stock List</a>
                        ...
                        <div class="tab-content" id="ex1-content">
                            <div class="tab-pane fade show active" id="SalesAll" role="tabpanel" aria-labelledby="SalesAlls">
                                <div class="table-responsive">
                                    <table id="" class="table table-sm table-bordered example" style="width:100%">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                            ...
                                            {{-- <tr> --}}
                                                ...
                                                <td class="maindffd">
                                                    <a href="{{url('orderRequirement/Stock-view-approve/'.$val->id.'/ALL')}}" class="btn btn-primary">View</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @php
