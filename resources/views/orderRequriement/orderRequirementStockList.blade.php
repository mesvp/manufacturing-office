...
<div class="card">
    <div class="app-content">
        ...
        <section class="section">
            <!-- <ol class="breadcrumb">
                <li class="breadcrumb-item">Procurement Request List Page</li>
            </ol> -->
                <div class="container-fluid">
                   <div class="row">
                        <div class="text-end">
                            @if(isset($EXT[18]['inputer']))
                            <a href="{{url('orderRequirement/orderRequirement')}}"><button class="btn btn-info btn-sm"><i class="fa-solid fa-plus"></i> Add Procurement Request</button></a>
                            @endif
                        </div>
                    </div>

                    <div class="row filter" id="allfilter"></div>

                    <div class="row">
                        <div class="col-lg-6 pl-3">
                            <ul class="nav nav-pills" id="ex1" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="active count nav-link p-2" id="SalesAlls" data-mdb-toggle="tab" href="#SalesAll" role="tab" aria-controls="All" aria-selected="true">All <span class="countss">{{count($Stock)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesApproveds" data-mdb-toggle="tab" href="#SalesApproved" role="tab" aria-controls="Approved" aria-selected="false">Approved <span class="countss">{{count($approved)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesPendings" data-mdb-toggle="tab" href="#SalesPending" role="tab" aria-controls="Pending" aria-selected="false">Pending <span class="countss">{{count($pending)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesHolds" data-mdb-toggle="tab" href="#SalesHold" role="tab" aria-controls="Hold" aria-selected="false">Hold <span class="countss">{{count($HOLD)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesRechecks" data-mdb-toggle="tab" href="#SalesRecheck" role="tab" aria-controls="Recheck" aria-selected="false">Recheck <span class="countss">{{count($RECHECK)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesObjects" data-mdb-toggle="tab" href="#SalesObject" role="tab" aria-controls="Object" aria-selected="false">Object <span class="countss">{{count($OBJECT)}}</span></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link count p-2" id="SalesRejects" data-mdb-toggle="tab" href="#SalesReject" role="tab" aria-controls="Reject" aria-selected="false">Reject <span class="countss">{{count($REJECT)}}</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="FilterButtonnn sales_fields">
                                <div class="raone">
                                    ...
                                    <div class="ukom myFilter" id="myFilter">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="Factory/Godowm_Name" value="Godown Name" onclick="filterTable(this)">
                                            <label class="form-check-label" for="Factory/Godowm_Name">Godown Name</label>
                                        </div>
                                        <div class="form-check">
                    ...
                    <!-- <div class="" id="main_btn_uddhan">
                        <a href="{{url('orderRequirement/orderRequirementStockList')}}" type="button" class="btn btn-default" id="stock">Requisition List</a>
                        ...
                        <div class="tab-content" id="ex1-content">
                            <div class="tab-pane fade show active" id="SalesAll" role="tabpanel" aria-labelledby="SalesAlls">
                                <div class="table-responsive">
                                    <table id="example2" class="table table-sm  table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            {{-- <tr> --}}
                                                ...
                                                <td class="maindffd">
                                                    @if(isset($val->status) && $val->status!=1)
                                                    <a href="{{url('orderRequirement/Stock_View/'.$val->id.'/ALL')}}" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i> View</a>
                                                    @if($val->Approve_status == 'RECHECK' && isset($EXT[18]['inputer']))
                                                    <a href="{{url('orderRequirement/orderRequirement/'.$val->id)}}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                                    @elseif($val->HoldStatus > 0)
                                                    <a href="{{url('orderRequirement/Stock_Release_Hold/'.$val->id)}}" class="btn btn-secondary btn-sm">Release</a>
                                                    @endif
                                                    @else
                                                    <a href="{{url('orderRequirement/orderRequirement/'.$val->id)}}" class="btn btn-warning btn-sm">Draft</a>
                                                    @endif
                                                </td>
                                            </tr>
                                            @endforeach
