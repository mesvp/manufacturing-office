...
<div class="card-form">
    <div class="app-content">
        ...
        <section class="section">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <a href="{{url('orderRequirement/orderRequirementApproveList')}}" class="btn btn-info mr-1 btn-sm"> <i class="fa fa-arrow-left"></i></a>
                                <a href="{{url('orderRequirement/orderRequirementApproveList')}}" class="btn btn-info btn-sm"> <i class="fa fa-home"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                $EXT = Session::get('EXT');
                @endphp
                @if($editStock->Approve_status!='REJECT')
                <form action="{{url('orderRequirement/Stock_approve')}}" method="POST">
                    ...
                    <div class="tab-content" id="myTabContent">
                        @if($editStock->Approve_status!='APPROVE' && in_array(1, $STEP) || in_array(2, $STEP) || in_array(3, $STEP) || isset($EXT[18]['Forward']))
