                ...
                <div class="border-bottom pb-2 row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="addbtn p-0"> <!-- class :- extra -->
                            ...
                            <a href="{{url('FinishedGood/Finished_Good_Approver_List')}}" class="btn btn-info mr-1 btn-sm"> <i class="fa fa-arrow-left"></i></a>
                            <a href="{{url('FinishedGood/Finished_Good_Approver_List')}}" class="btn btn-info btn-sm"> <i class="fa fa-home"></i></a>
                        </div>
                    </div>
                </div>
                <div id="row">
