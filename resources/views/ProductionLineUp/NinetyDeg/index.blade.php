        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('production-lineup/90deg-qc')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('production-lineup/90deg-qc-rejected')}}">
                      ...
                      <form>
                          <div class="col-md-12 row">
                              ...
                              <div class="col-md-3 mb-1 mt-4" style="text-align:right;">
                                  ...
                                  <a href="{{ url('production-lineup/90deg-qc') }}"><button type="button"
