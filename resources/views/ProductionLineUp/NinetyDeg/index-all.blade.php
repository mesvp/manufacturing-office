        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('production-lineup/90deg-qc-all')}}">
                            <i class="mdi mdi-account-outline mdi-20px me-1"></i>Pending For 90 Degree QC
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('production-lineup/90deg-qc-passed-all')}}">
                            <i class="mdi mdi-account-box-outline mdi-20px me-1"></i>Passed
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('production-lineup/90deg-qc-rejected-all')}}">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                        <h5 class="mb-0">Pending 90 Degree QC Details</h5>
                         <div class="text-end">
                            ...
                            <a href="{{ url('production-lineup/90deg-qc-excel') . '?' . http_build_query(request()->all()) }}"
                              ...
                              <tbody>
                                  @foreach ($AllLists as $item)
                                      <tr>
                                          ...
                                          <td>{{ $item->ninetydeg_source ?? 'ELQC' }}</td>
                                          <td>{{ $item->wattage ?? '-' }}</td>
                                          ...
                                          <td>
                                              @if($item->rwsts == '' && $item->sts == '0')
                                                  <a href="{{ route('delamination-view', ['id' => $item->ninetydeg_id]) }}?page=RWRK"
                                                      class="ms-2 btn btn-primary btn-sm waves-effect waves-light">
                                                      <span class="mdi mdi-playlist-plus me-1"></span> Add
                                                  </a>
                                              @else
                                                  <a href="{{ route('add_qc', ['id' => $item->elqc_batchNo, 'bid' => $item->elqc_id]) }}"
                                                      class="ms-2 btn btn-primary btn-sm waves-effect waves-light">
                                                      <span class="mdi mdi-playlist-plus me-1"></span> Add
                                                  </a>
                                              @endif
