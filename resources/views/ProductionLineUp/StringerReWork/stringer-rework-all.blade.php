...
@section('pageHeading')
    Stringer Rework Request List Details
@endsection
<style>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <!-- <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Stringer Re-Work Request</h5>
                        <div class="text-end">
                            <a href="{{ route('stringer-rework-add') }}"
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{url('production-lineup/stringer-rework')}}"><button type="button" class="btn btn-outline-success">Refresh</button></a>
                                </div>
                            </div>
                        </form>
                                            ...
                                            @foreach ($AllLists as $key => $apprvDataList)
                                                @if ($apprvDataList->status == 1)
                                                    <tr>
                                                        ...
                                                        <td>{{ $apprvDataList->StringSize ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('stringer-rework-view', ['id' => $apprvDataList->id]) }}"
                                            ...
                                            @foreach ($AllLists as $key => $rejectDataList)
                                                @if ($rejectDataList->status == 4)
                                                    <tr>
                                                        ...
                                                        <td>{{ $rejectDataList->StringSize ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('stringer-rework-view', ['id' => $rejectDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            ...
                                            @foreach ($AllLists as $key => $recheckDataList)
                                                @if ($recheckDataList->status == 2)
                                                    <tr>
                                                        ...
                                                        <td>{{ $recheckDataList->StringSize ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            @if ($recheckDataList->appr_process == 1 && $recheckDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                    href="{{ route('stringer-rework-form-update', ['id' => $recheckDataList->id]) }}"
                                                                    role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                            @endif
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('stringer-rework-view', ['id' => $recheckDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($pendDataList->appr_process == 0 && $pendDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                    href="{{ route('stringer-rework-form-update', ['id' => $pendDataList->id]) }}"
                                                                    role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                            @endif
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('stringer-rework-view', ['id' => $pendDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            ...
                                            @foreach ($AllLists as $key => $holdDataList)
                                                @if ($holdDataList->status == 3)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('stringer-rework-view', ['id' => $holdDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
