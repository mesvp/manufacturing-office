        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('production-lineup/junctionbox') }}" >
                            <i class="mdi mdi-account-outline mdi-20px me-1"></i>Pending For Junction Box
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('production-lineup/junctionbox/passed') }}">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                        ...
                        <div class="text-end">
                            ...
                            <a href="{{ url('production-lineup/junctionbox/pending-excel') . '?' . http_build_query(request()->all()) }}"
                                        ...
                                        <tbody>
                                            @foreach ($AllLists as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('add-junctionbox', ['id' => $item->ninetydeg_batchNo, 'bid' => $item->ninetydeg_barcode]) }}"
