        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('production-lineup/final-qc-all') }}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('production-lineup/final-qc/rejected-all') }}">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                        ...
                        <div class="text-end">
                            ...
                            <a href="{{ url('production-lineup/final-qc-excel') . '?' . http_build_query(request()->all()) }}"
