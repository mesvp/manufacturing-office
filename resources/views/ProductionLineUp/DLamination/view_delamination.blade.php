    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
                <h5 class="mb-0">90degree QC — Details</h5>
                <div class="text-end">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('production-lineup/dlamination/update/' . $e->ninetydeg_id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="rwrk_pg" value="{{ request()->page }}">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label class="form-label">QC No</label>
                            <input class="form-control" id="bushing_no" value="{{ $e->ninetydeg_laminatorNo ?? '-' }}"
                                readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Batch No</label>
                            <input class="form-control" id="batch_No" value="{{ $e->ninetydeg_batchNo ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Date</label>
                            <input class="form-control" id="date" value="{{ $e->ninetydeg_date ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Time</label>
                            <input class="form-control" id="time" value="{{ $e->ninetydeg_time ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" id="plant" value="{{ $e->ninetydeg_plant ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Operator</label>
                            <input class="form-control" id="operator"
                                value="{{ $e->operator_name ?? ($e->ninetydeg_operator ?? '-') }}" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Incharge</label>
                            <input class="form-control" id="incharge"
                                value="{{ $e->incharge_name ?? ($e->ninetydeg_incharge ?? '-') }}" readonly>
                        </div>
                    </div>
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="rfid"
                                                value="{{ $e->ninetydeg_rfid }}" placeholder="Fetch No." readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Bar Code</td>
                                        ...
                                        <td><input type="text" id="barcodeInput2" class="form-control" name="barCode"
                                                value="{{ $e->ninetydeg_barcode }}" placeholder="Fetch No."
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @if (!empty($defectDetails) && $defectDetails->count() > 0)
                                            @foreach ($defectDetails as $idx => $d)
                                                <tr>
                                                    <td>{{ $idx + 1 }}</td>
                                                    <input type="hidden" name="def_id[]" value="{{ $d->def_id }}">
                                                    <td>{{ $d->cell_no ?? '-' }}</td>
                                                    <td>{{ $d->cell_qty ?? '-' }}</td>
                                                    <td>{{ $d->defectRsn ?? '-' }}</td>
                                                    ...
                                                    <td>
                                                        @if(request()->query('page') !== 'RWRK')
                                                            <select class="form-select w-px-150" name="replace_data[]"
                                                            required>
                                                                <option value="NO"  {{ $d->replace == 'NO' ? 'selected' : '' }}>NO</option>
                                                                <option value="YES" {{ $d->replace == 'YES' ? 'selected' : '' }}>YES</option>
                                                            </select>
                                                        @else
                                                            {{ $d->replace ?? '' }}
                                                        @endif
