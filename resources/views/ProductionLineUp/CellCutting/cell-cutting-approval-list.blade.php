...
@section('pageHeading')
    Cell Cutting Approval List Details
@endsection
<style>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Cell Cutting Approval</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{url('production-lineup/cell-cutting-approval-list')}}"><button type="button" class="btn btn-outline-success">Refresh</button></a>
                                </div>
                            </div>
                        </form>
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    ...
                                                                    <li><a href="{{ url('production-lineup/cell-cutting-view/' . $pendDataList->id .'?menu=cell-cutting-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if (in_array($empId, $approverList) && $pendDataList->status == 0)
                                                                        <li><a href="{{ url('production-lineup/cell-cutting/approve/' . $pendDataList->id .'?menu=cell-cutting-approval-list') }}"
                                                                                class="dropdown-item"><i
                                                ...
                                                @if ($recheckDataList->status == 2 && $empId == $recheckDataList->actionBy)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('production-lineup/cell-cutting-view/' . $recheckDataList->id .'?menu=cell-cutting-approval-list') }}"
                                                                            class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"><i
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-inline-block">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end m-0">
                                                                    <li><a href="{{ url('production-lineup/cell-cutting-view/' . $holdDataList->id .'?menu=cell-cutting-approval-list') }}"
                                                                            class="dropdown-item"><i
                                                                                class="mdi mdi-eye"></i> View</a></li>

                                                                    @if ($holdDataList->actionBy == $empId && $holdDataList->status == 3)
                                                                        <li><a href="{{ url('production-lineup/cell-cutting/approve/' . $holdDataList->id .'?menu=cell-cutting-approval-list') }}"
                                                                                class="dropdown-item"><i
                                                                                    class="mdi mdi-check"></i> Approval
                                                                                Action</a></li>
                                                                    @endif
