...
@section('pageHeading')
    Cell Cutting Request List Details
@endsection
<style>
    #example th:nth-child(13), #example td:nth-child(13), #example2 th:nth-child(13), #example2 td:nth-child(13), #example3 th:nth-child(13), #example3 td:nth-child(13), #example4 th:nth-child(13), #example4 td:nth-child(13), #example5 th:nth-child(13), #example5 td:nth-child(13), #example6 th:nth-child(13), #example6 td:nth-child(13) {
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3 gap-2 gap-lg-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestAll" aria-controls="navs-purchaseorder" aria-selected="true">
                            <i class="mdi mdi-account-outline mdi-20px me-1"></i>All
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestApproved" aria-controls="navs-sales-id" aria-selected="false">
                            <i class="mdi mdi-account-box-outline mdi-20px me-1"></i>Approved
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestReject" aria-controls="navs-profit-id" aria-selected="false">
                            <i class="mdi mdi-cash-multiple mdi-20px me-1"></i>Reject
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestRecheck" aria-controls="navs-profit-id" aria-selected="false">
                            <i class="mdi mdi-bookmark-outline mdi-20px me-1"></i>Recheck
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestPending" aria-controls="navs-profit-id" aria-selected="false">
                            <i class="mdi mdi-checkbox-multiple-marked mdi-20px me-1"></i>Pending
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" role="tab" data-bs-toggle="tab"
                            data-bs-target="#navs-requestHold" aria-controls="navs-profit-id" aria-selected="false">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-label-primary py-1">
                        <h5 class="mb-0">Cell Cutting Request</h5>
                        <div class="text-end">
                            <a href="{{ route('cell-cutting-add') }}"
                        ...
                        <form>
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6 mb-1 mt-4" style="text-align:right;">
                                    ...
                                    <a href="{{url('production-lineup/cell-cutting')}}"><button type="button" class="btn btn-outline-success">Refresh</button></a>
                                </div>
                            </div>
                        </form>
                                            ...
                                            @foreach ($AllLists as $key => $apprvDataList)
                                                @if ($apprvDataList->status == 1)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('cell-cutting-view', ['id' => $apprvDataList->id]) }}"
                                            ...
                                            @foreach ($AllLists as $key => $rejectDataList)
                                                @if ($rejectDataList->status == 4)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('cell-cutting-view', ['id' => $rejectDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            ...
                                            @foreach ($AllLists as $key => $recheckDataList)
                                                @if ($recheckDataList->status == 2)
                                                    <tr>
                                                        ...
                                                        <td>{{ $recheckDataList->cellSize ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            @if($recheckDataList->appr_process == 1 && $recheckDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light" href="{{ route('cell-cutting-form-update', ['id' => $recheckDataList->id]) }}" role="button"><i class="mdi mdi-pencil"></i> Edit</a>
														    @endif
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('cell-cutting-view', ['id' => $recheckDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($pendDataList->appr_process == 0 && $pendDataList->created_by == $empId)
                                                                <a class="btn btn-warning btn-xs text-capitalize waves-effect waves-light"
                                                                    href="{{ route('cell-cutting-form-update', ['id' => $pendDataList->id]) }}"
                                                                    role="button"><i class="mdi mdi-pencil"></i> Edit</a>
                                                            @endif
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('cell-cutting-view', ['id' => $pendDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($AllLists as $key => $holdDataList)
                                                @if ($holdDataList->status == 3)
                                                    <tr>
                                                        <td>{{ $pendingCount++ }}</td>
                                                        <td>{{ date('d-m-Y', strtotime($holdDataList->date)) }}</td>
                                                        <td>{{ $holdDataList->shiftdtl ?? '' }}</td>
                                                        <td>{{ $holdDataList->wattage ?? '' }}</td>
                                                        <td>{{ $holdDataList->cellSize ?? '' }}</td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-xs text-capitalize waves-effect waves-light"
                                                                href="{{ route('cell-cutting-view', ['id' => $holdDataList->id]) }}"
                                                                role="button"><i class="mdi mdi-eye"></i> View</a>
                                                        </td>
                                                    </tr>
                                                @endif
