    ...
    <div class="app-content">
        ...
        <section class="section">
                <div class="container-fluid">
                    ...
                    @if($edit->aprvsts=='OBJECT' && $edit->userid==auth()->user()->id)
                    <form action="{{url('StockTransfer/approve')}}" method="POST">
                        ...
                        <a href="{{url('StockTransfer/StoreTransfer_View/'.$nextID)}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                        @else
                        <a href="{{url('StockTransfer/TransferRequestList')}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
                        @endif
                    </form>
                    @else
                    <form action="{{url('StockTransfer/approve')}}" method="POST">
