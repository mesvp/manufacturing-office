                      ...
                      <div class="col-sm-11 tab1">
                        <div class="row">
                            ...
                            <label>Plant Name*</lable>
                              <div class="field-wrap">
                                <select name="Plant_Name[{{$i}}]" class="form-select form-select-sm" required>
                                  ...
                                  @if($val->Approve_status != "APPROVE" && $val->Approve_status != "HOLD" &&    $val->Approve_status != "FORWARD" && $val->Approve_status != "OBJECT" && $val->Approve_status != "RECHECK")
                          ...
                          <div class="col-sm-3 form-group">
                            <label>UOM</lable>
                              <div class="field-wrap">
                                {{-- <select name="Material_Name[{{$i}}]" class="form-select form-select-sm" id="materialname{{$i}}" onclick="product({{$i}})" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($materials as $val)
                                  <option value="{{$val->id}}" {{isset($plantmach->Material_Name) && $plantmach->Material_Name==$val->id?'selected':''}}>{{$val->material_name}}</option>
                                  @endforeach
                                </select> --}}
                                <select name="uom_prd[{{$i}}]" class="form-select form-select-sm" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($uom as $val)
                                  <option value="{{$val->id}}" {{isset($plantmach->uom_prd) && $plantmach->uom_prd==$val->id?'selected':''}}>{{$val->UOMs}}</option>
                                  @endforeach
                                </select>
                              </div>
                          </div>
                              ...
                              <div class="row">
                                <div class="col-sm-3 form-group">
                                 ...
                                 <div class="col-sm-4 form-group">
                                  <label>Machine Description*</lable>
                                    <p><input class="form-control form-control-sm" name="Machine_description[{{$i}}][{{$j}}]" value="{{isset($machinename->Machine_description) && $machinename->Machine_description!=''?$machinename->Machine_description:''}}" required></p>
                                </div>
                                ...
                                {{-- <div class="col-sm-3 form-group">
                                 ...
                                 <div class="col-sm-3 form-group">
                                  <label>Attachement</lable>
                                    <p><input class="form-control form-control-sm" type="file" name="Attachement_warrenty{{$i}}{{$j}}"></p>
                                    <div class="downloadfile" id="attachement">
                                         <div>{{substr(isset($warrnty->Attachement_warrenty) && $warrnty->Attachement_warrenty!=''?$warrnty->Attachement_warrenty:'', 21)}}</div>
                        ...
                        <div class="row">
                          <div class="col-sm-3 form-group">
                            <label> Date Of Purchase*</lable>
                              <p><input class="form-control form-control-sm" type="date" max="{{ now()->toDateString('Y-m-d') }}" name="Date_Of_Purchase[{{$i}}]" value="{{isset($plantmach->Date_Of_Purchase) && $plantmach->Date_Of_Purchase!=''?$plantmach->Date_Of_Purchase:''}}"></p>
                          </div>
                          <div class="col-sm-4 form-group">
                            <label>Machine Company Name*</lable>
                              <p><input class="form-control form-control-sm" name="Machine_Company_Name[{{$i}}]" value="{{isset($plantmach->Machine_Company_Name) && $plantmach->Machine_Company_Name!=''?$plantmach->Machine_Company_Name:''}}" ></p>
                          </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm-11 tab1">
                        <div class="row">
                          ...
                          {{-- <div class="col-sm-3 form-group">
                            <label>Material Name</lable>
                              <div class="field-wrap">
                                <select name="Material_Name[0]" id="materialname" class="form-select form-select-sm" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($materials as $val)
                          ...
                          <div class="col-sm-3 form-group">
                            <label>UOM</lable>
                              <div class="field-wrap">
                                <select name="uom_prd[0]" class="form-select form-select-sm" required>
                                  <option value="" selected disabled>Select</option>
                                  @foreach($uom as $val)
                                  <option value="{{$val->id}}" {{isset($warrnty->UOMs) && $warrnty->UOMs==$val->id?'selected':''}}>{{$val->UOMs}}</option>
                                  @endforeach
                        ...
                        <table class="table table-bordered" id="dynamic_fieldaddmachine0">
                          <div class="row">
                            ...
                            {{-- <div class="col-sm-3 form-group">
                             ...
                             <div class="col-sm-4 form-group">
                                <label>Machine Description*</lable>
                                <p><input class="form-control form-control-sm" name="Machine_description[0][0]" required></p>
                            </div>
                            {{-- <div class="col-sm-3 form-group">
                          ...
                          <tr>
                            <td>
                              <div class="row">
                                <div class="col-sm-3 form-group">
                                  <label> Warranty*</lable>
                                    <select name="Warranty[0][0]" class="form-select form-select-sm" >
                                      <option value="" selected disabled>Select</option>
                                      @foreach($Warranty as $val)
                                ...
                                {{-- <div class="col-sm-3 form-group">
                                 ...
                                 <div class="col-sm-3 form-group">
                                  <label>Attachement</lable>
                                    <p><input class="form-control form-control-sm" type="file" name="Attachement_warrenty00"></p>
                                </div>
                                {{-- <div class="col-sm-3 form-group">
                                  <label>UOM*</lable>
                                    <div class="field-wrap">
                        ...
                        <div class="row">
                          <div class="col-sm-3 form-group">
                            <label> Date Of Purchase*</lable>
                              <p><input class="form-control form-control-sm" type="date" max="{{ now()->toDateString('Y-m-d') }}" name="Date_Of_Purchase[0]"></p>
                          </div>
                          <div class="col-sm-4 form-group">
                            <label>Machine Company Name*</lable>
                              <p><input class="form-control form-control-sm" name="Machine_Company_Name[0]" ></p>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-12 form-group">
...
<!-- <script>
  $(document).ready(function() {
    $(".dropdowndisable").on("change", function() {
...
<script>
  ...
  //   $('#dynamic_fieldaddmachine' + i).append('<tr id="rowaddmachine' + i + '' + j + '"><td> <div class="row"> <div class="col-sm-3 form-group"> <label>Machine Name*</lable><select name="Machine_Name[' + i + '][' + j + ']" class="form-select form-select-sm" required><option value="" selected disabled>Select</option> @foreach($MachineName as $val)<option value="{{$val->id}}">{{$val->Machine_Name}}</option> @endforeach </select> </div><div class="col-sm-4 form-group"><label>Machine Description*</lable> <p><input class="form-control form-control-sm" name="Machine_description[' + i + '][' + j + ']" id="Machine_description' + i + j + '" required></p> </div><div class="col-sm-3 form-group"><a href="javascript:;" onclick="removemachine(' + i + ',' + j + ')"  class="btn btn-danger btn-sm mt-4 btn_remove mt-4">X</a></div></div></td></tr>');
  //   j++;
  //   $("#addmachine" + i).attr("onclick", 'addmachine(' + i + ',' + j + ')');
  // }
  function addmachine(i, j) {
    j++; // Increment j for the new row
    $('#dynamic_fieldaddmachine' + i).append('<tr id="rowaddmachine' + i + '' + j + '"><td> <div class="row"> <div class="col-sm-3 form-group"> <label>Machine Name*</label><select name="Machine_Name[' + i + '][' + j + ']" class="form-select form-select-sm" required><option value="" selected disabled>Select</option> @foreach($MachineName as $val)<option value="{{$val->id}}">{{$val->Machine_Name}}</option> @endforeach </select> </div><div class="col-sm-4 form-group"><label>Machine Description*</label> <p><input class="form-control form-control-sm" name="Machine_description[' + i + '][' + j + ']" id="Machine_description' + i + j + '" required></p> </div><div class="col-sm-3 form-group"><a href="javascript:;" onclick="removemachine(' + i + ',' + j + ')"  class="btn btn-danger btn-sm mt-4 btn_remove mt-4">X</a></div></div></td></tr>');
    $("#addmachine" + i).attr("onclick", 'addmachine(' + i + ',' + j + ')');
}
...
<script>
  ...
  function addmachinepage(i) {
    var a = ' <div class="row" style="margin-top:20px;" id="removemachinepage' + i + '"> <div class="col-sm-11 tab1"> <div class="row"> <div class="col-sm-3 form-group"> <label>Plant Name*</lable><div class="field-wrap"><select name="Plant_Name[' + i + ']" class="form-select form-select-sm" id="plant_name_id" required><option value="" selected disabled>Select</option>@foreach($masterplant as $val) @if($val->Approve_status != "APPROVE" && $val->Approve_status != "HOLD" &&    $val->Approve_status != "FORWARD" && $val->Approve_status != "OBJECT" && $val->Approve_status != "RECHECK")<option value="{{$val->id}}">{{$val->spname}}</option>@endif @endforeach</select> <span class="error-message" style="color: red; display: none;"></span> </div></p></div><div class="col-sm-3 form-group"> <label>Production Capacity*</lable><p><input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control form-control-sm" name="Production_Capacity[' + i + ']" required></p></div><div class="col-sm-3 form-group"><label>UOM</lable><div class="field-wrap"><select name="uom_prd[' + i + ']" class="form-select form-select-sm" required><option value="" selected disabled>Select</option>@foreach($uom as $val)<option value="{{$val->id}}" {{isset($warrnty->UOMs) && $warrnty->UOMs==$val->id?'selected':''}}>{{$val->UOMs}}</option>@endforeach </select></div></div> <table class="table table-bordered" id="dynamic_fieldaddmachine' + i + '"> <tr> <div class="row"> <div class="col-sm-3 form-group"> <label>Machine Name*</lable><select name="Machine_Name[' + i + '][0]" class="form-select form-select-sm" required><option value="" selected disabled>Select</option> @foreach($MachineName as $val)<option value="{{$val->id}}">{{$val->Machine_Name}}</option> @endforeach </select> </div><div class="col-sm-4 form-group"><label>Machine Description*</lable> <p><input class="form-control form-control-sm" name="Machine_description[' + i + '][0]" required></p> </div><div class="col-sm-3 form-group"> <button type="button" id="addmachine' + i + '" onclick="addmachine(' + i + ',1)" class="btn btn-success btn-sm mt-4 mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button> </div></div></tr></table> <table class="table table-bordered" id="dynamic_fieldaddwarnty' + i + '"> <tr> <td> <div class="row"> <div class="col-sm-3 form-group"> <label> Warranty*</lable><select name="Warranty[' + i + '][0]" class="form-select form-select-sm" > <option value="" selected disabled>Select</option> @foreach($Warranty as $val)<option value="{{$val->id}}">{{$val->Warranty}}</option>@endforeach </select> </div><div class="col-sm-3 form-group"><label>Attachement</lable>     <p><input class="form-control form-control-sm" type="file" name="Attachement_warrenty' + i + '0"></p></div><div class="col-sm-3 form-group"> <button type="button" id="addwarrnty' + i + '" onclick="addwarnty(' + i + ',1)" class="btn btn-success btn-sm mt-4 mt-4"><i class="fa fa-plus" aria-hidden="true"></i></button> </div></div></td></tr></table> <div class="row"> <div class="col-sm-3 form-group"> <label> Date Of Purchase*</lable> <p><input class="form-control form-control-sm"  type="date" max="{{ now()->toDateString(' + Y - m - d + ') }}" name="Date_Of_Purchase[' + i + ']" ></p></div><div class="col-sm-4 form-group"> <label>Machine Company Name*</lable> <p><input class="form-control form-control-sm"  name="Machine_Company_Name[' + i + ']" ></p></div></div><div class="row"> <div class="col-sm-12 form-group"> <label>Others</lable> <table class="table table-bordered" id="dynamic_fieldaddother' + i + '"> <tr> <td><a href="javascript:;" type="button" id="addothers' + i + '" onclick="addothers(' + i + ',0)" class="btn btn-success btn-sm mt-4 mt-4"><i class="fa fa-plus" aria-hidden="true"></i></a></td></tr></table> </div><div class="col-sm-12 form-group"> <label for="State">Remarks:</label> <textarea name="Remarks[' + i + ']" id="" cols="30" rows="5" class="form-control form-control-sm"></textarea> </div></div></div><div class="col-sm-1"> <a href="javascript:;"  onclick="removemachinepage(' + i + ')" class="btn btn-danger btn-sm mt-4">X</a> </div></div>';
    i++;
    $("#mainddd").append(a);
    $("#plant_name_id").select2(); 
