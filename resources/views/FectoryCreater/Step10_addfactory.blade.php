                ...
                <div class="row">
                  <div class="col-sm-3 form-group">
                    <label>Total Rack</lable>
                      <p><input type="number" class="form-control form-control-sm" name="Total_Rack" value="{{isset($storee->Total_Rack) && $storee->Total_Rack!=''?$storee->Total_Rack:''}}" ></p>
                  </div>
                  <div class="col-sm-3 form-group">
                    <label> Rack Capacity</lable>
                      <p><input type="number" class="form-control form-control-sm" id="RackCapacityFirst" name="Rack_Capacity" value="{{isset($storee->Rack_Capacity) && $storee->Rack_Capacity!=''?$storee->Rack_Capacity:''}}" ></p>
                  </div>
                  <div class="col-sm-3 form-group">
                    <label>Total Bin</lable>
                      <p><input type="number" class="form-control form-control-sm" name="Total_Bin" value="{{isset($storee->Total_Bin) && $storee->Total_Bin!=''?$storee->Total_Bin:''}}" ></p>
                  </div>
                  <div class="col-sm-3 form-group">
                    <label>Total Bin Capacity</lable>
                      <p><input type="number" class="form-control form-control-sm" name="Total_Bin_Capacity" value="{{isset($storee->Total_Bin_Capacity) && $storee->Total_Bin_Capacity!=''?$storee->Total_Bin_Capacity:''}}" ></p>
                  </div>
                </div>
                <div class="tab1">
                  <div class="row">
                    <div class="col-sm-3 form-group">
                      <label> Rack No.</lable>
                        <p><input type="number" class="form-control form-control-sm" name="Rack_No" value="{{isset($storee->Rack_No) && $storee->Rack_No!=''?$storee->Rack_No:''}}" ></p>
                    </div>
                    <div class="col-sm-3 form-group">
                      <label> Rack Capacity</lable>
                        <p><input type="number" class="form-control form-control-sm" style="margin-left:8px;" id="RackCapacitySecond" name="Rack_Capacities" value="{{isset($storee->Rack_Capacities) && $storee->Rack_Capacities!=''?$storee->Rack_Capacities:''}}" ></p>
                    </div>
                  </div>
                  <h6>Details:</h6>
                  <hr>
                        ...
                        <div class="row">
                          <div class="col-sm-5 form-group">
                            <label> Sub Rack No.</lable>
                              <p><input type="number" class="form-control form-control-sm" name="Sub_Rack_No[{{$i}}]" value="{{isset($val->Sub_Rack_No) && $val->Sub_Rack_No!=''?$val->Sub_Rack_No:''}}" ></p>
                          </div>
                          <div class="col-sm-6 form-group">
                            <label> Sub Rack Capacity</lable>
                              <p><input type="number" class="form-control form-control-sm" name="Sub_Rack_Capacity[{{$i}}]" value="{{isset($val->Sub_Rack_Capacity) && $val->Sub_Rack_Capacity!=''?$val->Sub_Rack_Capacity:''}}" ></p>
                          </div>
                        </div>
                        <div id="dynamic_field{{$i}}">
                          ...
                          <div class="sub-capacty" id="remsub-capacty{{$i}}{{$j}}">
                            <div class="row">
                              <div class="col-sm-5 form-group">
                                <label> Bin No.</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Bin_No[{{$i}}][{{$j}}]" value="{{isset($storebin->Bin_No) && $storebin->Bin_No!=''?$storebin->Bin_No:''}}" ></p>
                              </div>
                              <div class="col-sm-5 form-group">
                                <label> Bin Capacity</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Bin_Capacity[{{$i}}][{{$j}}]" value="{{isset($storebin->Bin_Capacity) && $storebin->Bin_Capacity!=''?$storebin->Bin_Capacity:''}}" ></p>
                              </div>
                              @if($j==1)
                              ...
                              <div class="row" id="remSub_Bin_No{{$j}}{{$k}}">
                                <div class="col-sm-5 form-group">
                                  <label>Sub Bin No.</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Bin_No[{{$i}}][{{$j}}][{{$k}}]" value="{{isset($storesubbin->Sub_Bin_No) && $storesubbin->Sub_Bin_No!=''?$storesubbin->Sub_Bin_No:''}}" ></p>
                                </div>
                                <div class="col-sm-5 form-group">
                                  <label>Sub Bin Capacity</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Bin_Capacity[{{$i}}][{{$j}}][{{$k}}]" value="{{isset($storesubbin->Sub_Bin_Capacity) && $storesubbin->Sub_Bin_Capacity!=''?$storesubbin->Sub_Bin_Capacity:''}}" ></p>
                                </div>
                                @if($k==1)
                                <div class="col-sm-2 form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        <div class="row">
                          <div class="col-sm-5 form-group">
                            <label> Sub Rack No.</lable>
                              <p><input type="number" class="form-control form-control-sm" name="Sub_Rack_No[0]" ></p>
                          </div>
                          <div class="col-sm-6 form-group">
                            <label> Sub Rack Capacity</lable>
                              <p><input type="number" class="form-control form-control-sm" name="Sub_Rack_Capacity[0]" ></p>
                          </div>
                        </div>
                        <div id="dynamic_field0">
                          <div class="sub-capacty">
                            <div class="row">
                              <div class="col-sm-5 form-group">
                                <label> Bin No.</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Bin_No[0][0]" ></p>
                              </div>
                              <div class="col-sm-5 form-group">
                                <label> Bin Capacity</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Bin_Capacity[0][0]" ></p>
                              </div>
                              <div class="col-sm-2 form-group">
                            ...
                            <div id="dynamic_field00">
                              <div class="row">
                                <div class="col-sm-5 form-group">
                                  <label>Sub Bin No.</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Bin_No[0][0][0]" ></p>
                                </div>
                                <div class="col-sm-5 form-group">
                                  <label>Sub Bin Capacity</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Bin_Capacity[0][0][0]" ></p>
                                </div>
                                <div class="col-sm-2 form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-5 form-group">
                          <label>Total Shelf</lable>
                            <p><input type="number" class="form-control form-control-sm" name="Total_Shelf" value="{{isset($shelf->Total_Shelf) && $shelf->Total_Shelf!=''?$shelf->Total_Shelf:''}}" ></p>
                        </div>
                        <div class="col-sm-6 form-group">
                          <label> Total Shelf Capacity</lable>
                            <p><input type="number" class="form-control form-control-sm" name="Total_Shelf_Capacity" value="{{isset($shelf->Total_Shelf_Capacity) && $shelf->Total_Shelf_Capacity!=''?$shelf->Total_Shelf_Capacity:''}}" ></p>
                        </div>
                      </div>
                            ...
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Shelf No.</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Shelf_No[{{$i}}]" value="{{isset($val->Shelf_No) && $val->Shelf_No!=''?$val->Shelf_No:''}}" ></p>
                              </div>
                              <div class="col-sm-6 form-group">
                                <label> Shelf Capacity</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Shelf_Capacity[{{$i}}]" value="{{isset($val->Shelf_Capacity) && $val->Shelf_Capacity!=''?$val->Shelf_Capacity:''}}" ></p>
                              </div>
                            </div>
                              ...
                              <div class="row" id="removeshelf{{$i}}{{$j}}">
                                <div class="col-sm-6 form-group">
                                  <label>Sub Shelf No.</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Shelf_No[{{$i}}][{{$j}}]" value="{{isset($subshelfsss->Sub_Shelf_No) && $subshelfsss->Sub_Shelf_No!=''?$subshelfsss->Sub_Shelf_No:''}}" ></p>
                                </div>
                                <div class="col-sm-4 form-group">
                                  <label>Sub Shelf Capacity</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Shelf_Capacity[{{$i}}][{{$j}}]" value="{{isset($subshelfsss->Sub_Shelf_Capacity) && $subshelfsss->Sub_Shelf_Capacity!=''?$subshelfsss->Sub_Shelf_Capacity:''}}" ></p>
                                </div>
                                @if($j==1)
                                <div class="col-sm-2 form-group">
                        ...
                        <div class="row">
                          <div class="col-sm-10  inner-div">
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Shelf No.</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Shelf_No[0]" ></p>
                              </div>
                              <div class="col-sm-6 form-group">
                                <label> Shelf Capacity</lable>
                                  <p><input type="number" class="form-control form-control-sm" name="Shelf_Capacity[0]" ></p>
                              </div>
                            </div>
                            <div id="dynamic_field_ravi0">
                              <div class="row">
                                <div class="col-sm-6 form-group">
                                  <label>Sub Shelf No.</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Shelf_No[0][0]" ></p>
                                </div>
                                <div class="col-sm-4 form-group">
                                  <label>Sub Shelf Capacity</lable>
                                    <p><input type="number" class="form-control form-control-sm" name="Sub_Shelf_Capacity[0][0]" ></p>
                                </div>
                                <div class="col-sm-2 form-group">
