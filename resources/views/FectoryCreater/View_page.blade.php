                                                ...
                                                <tr id="rows{{$i}}">
                                                    ...
                                                    <td>
                                                        <div class="field-wrap">
                                                            ...
                                                            @foreach($landattch as $val)
                                                                        <div class="field-wrap form-select form-select-sm" id="kim_id">
                                                                            <a href="{{url('storage/'.$val->attachement)}}" target="_blank" download>Download</a>
                                                                        </div>
                                                            @endforeach
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4 form-group">
                                                    <label>Generator*</lable>
                                                        <p><input disabled type="text" class="form-control form-control-sm" placeholder="" name="generator[]" value="{{isset($val->generator) && $val->generator!=''?$val->generator:''}}" required></p>
                                                </div>
                                                <div class="col-sm-4 form-group">
