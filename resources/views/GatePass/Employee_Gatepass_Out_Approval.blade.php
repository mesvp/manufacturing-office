...
@section('main-container')
    ...
    <title>OUT Employee Gate Pass Approval List Details Page</title>
    <style>
        * {
    ...
    <div class="card">
        <div class="app-content">
            ...
            <section class="section p-2">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">OUT Employee Gate Pass Approval List Page</li>
                </ol>
                <div class="row">
                    <div class="container">
                        <form action="{{ url('GatePass/filtered_ApproveOutEmp') }}" method="POST">
                            @csrf
                            <div class="row filter">
                                ...
                                <div class="col-2 mt-4">
                                    ...
                                    <a href="{{ url('GatePass/Employee_Gatepass_Out_Approval') }}"><button type="button"
                                    ...
                                    @foreach ($employeedata as $key => $val)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('GatePass/employee_gatepass_approval_view/' . $val->id .'/'.'out') }}" class="btn btn-primary">VIEW</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
