                            ...
                            <div class="tab1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <input class="form-control form-control-sm" type="text" name="visitor_code[]" placeholder="Enter Visitor code" value="{{ isset($Manufacturing_unitdata[$edit->project_id]) ? $Manufacturing_unitdata[$edit->project_id] : 'N/A' }}" required disabled>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label class="fw-bold" for="Plant_Name">Sub Cost Center</label>
                                        <input class="form-control form-control-sm" type="text" name="visitor_code[]" placeholder="Enter Visitor code" value="{{ isset($plant_namedata[$edit->subproject_id]) ? $plant_namedata[$edit->subproject_id] : 'N/A' }}" required disabled>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label class="fw-bold">Organisation Name</label>
                                        <input class="form-control form-control-sm" type="text" name="visitor_code[]" placeholder="Enter Visitor code" value="{{ isset($orgdata[$edit->org_id]) ? $orgdata[$edit->org_id] : 'N/A' }}" required disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <input class="form-control form-control-sm" id="intime" type="text" name="request_in_time" placeholder="Request In Time" value="{{ isset($edit->request_in_time) && $edit->request_in_time != '' ? $edit->request_in_time : '' }}" required disabled>
                                    </div>
                                    <div class="col-sm-4 form-group">
                                        <label class="fw-bold">Expected Out Time</label>
                                        <input class="form-control form-control-sm" id="outtime" type="text" name="request_out_time" placeholder="Request Out Time" value="{{ isset($edit->request_out_time) && $edit->request_out_time != '' ? $edit->request_out_time : '' }}" required disabled>
                                    </div>
                                    <div class="col-sm-4 form-group">
                                        <label class="fw-bold">Actual Out Time</label>
                                        <input class="form-control form-control-sm" id="outtime" type="text" name="request_out_time" placeholder="Request Out Time" value="{{ isset($edit->actual_out_time) && $edit->actual_out_time != '' ? date('d-m-Y h:i A' , strtotime($edit->actual_out_time)) : '' }}" required disabled>
                                    </div>
                                    <div class="col-sm-4 form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        type = '{{$type}}';
        req_no = '{{$req_no}}';
        $.post("{{url('GatePass/visitor_inputeraction')}}", {
            id: id,
            type: type,
            req_no: req_no
        }, function(data) {
