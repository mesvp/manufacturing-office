...
@section('main-container')
    ...
    <title>OUT Gate Pass Material Approval List Details</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <h4>OUT Gate Pass Material Approval List</h4>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">

                        </div>
                    </div>
                    <form action="{{ url('GatePass/filtered_ApproveMaterial_Out') }}" method="POST">
                        @csrf
                        <div class="row filter">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 form-group">
                                <label for="" class="form-label">OUT Invoice No.</label>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 form-group">
                                <label for="" class="form-label">OUT E - way Bill Number</label>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-2 col-sm-6 mt-4">
                                <div class="">
                                    ...
                                    <a href="{{ url('GatePass/Material_Gatepass_Out_Approval') }}">
                                    ...
                                    <div class="raone">
                                        ...
                                        <div class="ukom" id="myFilter">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="in_dt_time">Out Date & Time</label>
                                            </div>
                                            <div class="form-check">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="in_inv_no">Out Invoice No</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="in_bill_number"
                                                    value="Out E - Way Bill Number" onclick="filterTable(this)">
                                                <label class="form-check-label" for="in_bill_number">Out E - Way Bill
                                                    Number</label>
                                            </div>
                                            <div class="form-check">
                                ...
                                @foreach ($materialdata as $key => $val)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('GatePass/Material_out_view/' . $val->id . '/approval') }}"
