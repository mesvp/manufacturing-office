...
@section('main-container')
    ...
    <title>OUT Gate Pass Material View Details</title>
    <style>
        .tab {
            display: none;
        }
                            ...
                            <div class="tabs">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                <h5>OUT Material Gate Pass Details</h5>
                                            </div>
                                            <div class="col">
                                ...
                                <div class="tab1">
                                    <form id="submitform" action="#" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            @endif
                                            <div class="col-sm-3 form-group">
                                                <label>Out Weight Details(KG)<span
                                                        class="text-danger fw-bolder">*</span></label>
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label>Insurance Valid Date<span
                                                        class="text-danger fw-bolder">*</span></label>
                                                <input class="form-control form-control-sm" type="text"
                                                    name="insurance_dt" placeholder="Insurance No."
                                                    value="{{ isset($edit->insurance_dt) && $edit->insurance_dt != '' ? date('d-m-Y', strtotime($edit->insurance_dt)) : '' }}"
                                                    readonly>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label>Out Date & Time<span class="text-danger fw-bolder">*</span></label>
                                                        ...
                                                        <tbody id="GatepassFields">
                                                            ...
                                                            @foreach ($in_items as $in_item)
                                                                <tr>
                                                                    ...
                                                                    @php
                                                                        $mat_name = App\Models\MaterialManagement\MaterialManagement_Add_Material::select(
                                                                            'prj_material.material_name as matname',
                                                                        )
                                                                            ->leftJoin(
                                                                                'prj_material',
                                                                                'materialmanagement_add_material.Material_Name',
                                                                                '=',
                                                                                'prj_material.id',
                                                                            )
                                                                            ->where(
                                                                                'materialmanagement_add_material.id',
                                                                                $in_item->item_desc,
                                                                            )
                                                                            ->first();
                                                                    @endphp
                                                                    <td>
                                                                        <input class="form-control form-control-sm"
                                                                            ...
                                                                            value="{{ $mat_name ? $mat_name->matname : $in_item->item_desc }}"
                                                                            readonly>
                                                                    </td>
                                                                    <td>
                                                                        <select
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary"
                                                                            onclick="openModal(<?php echo $j; ?>)">SERIAL
                                                                            NO</button>
    
                                                                        <!-- Modal -->
                                                                        <div class="modal" id="modal_<?php echo $j; ?>"
                                                                            style="display: none;">
                                                                            <div class="modal-dialog modal-md">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h4 class="modal-title">
                                                                                            {{ $slno_detail->matName }}</h4>
                                                                                        <button type="button"
                                                                                            class="btn btn-danger"
                                                                                            onclick="closeModal(<?php echo $j; ?>)"
                                                                                            data-dismiss="modal">&times;</button>
                                                                                    </div>
    
    
                                                                                    <div class="modal-body" style="overflow-y: auto; max-height: 400px; border: 1px solid #ccc; padding: 10px;">
                                                                                        @php
                                                                                            $serials = App\Models\GatePass\GatepassSlno::where(
                                                                                                'gp_reqNo',
                                                                                                $edit->request_no,
                                                                                            )
                                                                                                ->where(
                                                                                                ...
                                                                                                ->whereNotNull('slno_dtls')
                                                                                                ->pluck('slno_dtls');
                                                                                        @endphp
                                                                                        <ul class="pl-0">
                                                                                            @forelse ($serials as $sn)
                                                                                                <li style="list-style: none; border: 1px solid #c1c1c1; padding: 4px; font-size: 15px; margin-bottom: 5px;">
                                                                                                    {{ $sn }}
                                                                                                </li>
                                                                                            @empty
...
@push('custom-scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (action === 'approval') {
                $.post("{{ url('GatePass/material_out_action') }}", {
                    id: id,
                    type: type,
                    req_no: req_no
                }, function(data) {
                ...
                $.post("{{ url('GatePass/material_out_inputeraction') }}", {
                    id: id,
                    type: type,
                    req_no: req_no
                }, function(data) {
    ...
    <script type="text/javascript">
        function openModal(rowIndex) {
            document.getElementById(`modal_${rowIndex}`).style.display = "block";
        }

        function closeModal(rowIndex) {
            document.getElementById(`modal_${rowIndex}`).style.display = "none";
        }
    </script>
@endpush
