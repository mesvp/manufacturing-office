...
@section('main-container')
    ...
    <title>OUT Visitor Gate Pass Approval List Details Page</title>
    <style>
        * {
    ...
    <div class="card">
        <div class="app-content">
            ...
            <section class="section p-2">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">OUT Visitor Gate Pass Approval List Page</li>
                </ol>
                <div class="row">
                    <div class="container">
                        <form action="{{ url('GatePass/filtered_ApproveOutVisitor') }}" method="POST">
                            @csrf
                            <div class="row filter">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="Request_No" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        @foreach ($DropdownData as $val)
                                            <?php
                                    $RequestNo = isset($val->out_request_no) && $val->out_request_no != '' ? $val->out_request_no : '';
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="Request_By" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        @foreach ($DropdownData as $val)
                                            <?php
                                    $RequestBy = isset($val->out_request_by) && $val->out_request_by != '' ? $val->out_request_by : '';
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="Security_Guard" class="form-select form-select-sm js-example-matcher-start">
                                        ...
                                        @foreach ($DropdownData as $val)
                                            <?php
                                    $SecurityGuard = isset($val->out_sec_guard) && $val->out_sec_guard != '' ? $val->out_sec_guard : '';
                                ...
                                <div class="col-2 mt-4">
                                    ...
                                    <a href="{{ url('GatePass/Visitor_Gatepass_Out_Approval') }}"><button type="button"
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered w-00">
                                ...
                                <tbody>
                                    @foreach ($visitordata as $key => $val)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            ...
                                            <td>{{ isset($val->request_in_time) ? date('d-m-Y h:i A', strtotime($val->request_in_time)) : 'N/A' }}
                                            </td>
                                            <td>{{ isset($val->request_out_time) ? date('d-m-Y h:i A', strtotime($val->request_out_time)) : 'N/A' }}
                                            </td>
                                            <td>{{ isset($val->prsn_vehicle) ? ($val->prsn_vehicle == 1 ? 'Yes' : 'No') : 'N/A' }}
                                            </td>
                                            <td>{{ isset($val->out_sec_guard) ? $val->out_sec_guard : 'N/A' }}</td>
                                            ...
                                            <td class="PendingColor">
                                                @if (
                                                    ($val->Out_Approve_status === 'FORWARD' && isset($val->status) && $val->status != 1) ||
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('GatePass/visitor_gatepass_approval_view/' . $val->id .'/'.'out') }}" class="btn btn-primary">VIEW</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
