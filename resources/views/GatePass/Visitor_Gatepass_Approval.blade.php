...
@section('main-container')
    ...
    <title>IN Visitor Gate Pass Approval List Details Page</title>
    <style>
        * {
    ...
    <div class="card">
        <div class="app-content">
            ...
            <section class="section p-2">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">IN Visitor Gate Pass Approval List Page</li>
                </ol>
                <div class="row">
                    <div class="container">
                        <form action="{{ url('GatePass/filtered_ApproveVisitor') }}" method="POST">
                            @csrf
                            <div class="row filter">
                                ...
                                <div class="col-2 mt-4">
                                    ...
                                    <a href="{{ url('GatePass/Visitor_Gatepass_Approval') }}"><button type="button"
                                    ...
                                    @foreach ($visitordata as $key => $val)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('GatePass/visitor_gatepass_approval_view/' . $val->id .'/'.'in') }}" class="btn btn-primary">VIEW</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
