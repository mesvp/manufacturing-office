...
<form action="{{url('InventoryManagement/approve')}}" method="POST">
    ...
    <a href="{{url('InventoryManagement/InputerView/'.$nextID)}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
    @else
    <a href="{{url('InventoryManagement/InventoryManagementList')}}"><button type="button" class="btn btn-secondary">NEXT</button></a>
    @endif
</form>
@else
<form action="{{url('InventoryManagement/approve')}}" method="POST">
